...
const PREFIX = "projects/bstudio-social"; // percorso di questo progetto dentro il repo
...
for (const p of queue) {
  ...
  p.assets.forEach((a, i) => { md += `${i + 1}. ${BASE}/${PREFIX}/${a}\n`; });
...
await writeFile(path.join(ROOT, "docs", "POSTING-KIT.md"), md, "utf8");
