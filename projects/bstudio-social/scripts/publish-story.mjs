...
// Le Story durano 24h e non hanno caption (il testo è già nell'immagine 1080x1920). Uso: node scripts/publish-story.mjs [--dry-run]
...
const assetUrl = (rel) => `${ASSET_BASE_URL.replace(/\/$/, "")}/${ASSET_PREFIX}/${rel.replace(/\\/g, "/")}`;
