...
//
// Uso:
//   node scripts/reply-bot.mjs --dry-run        // mostra cosa risponderebbe, senza postare
//   node scripts/reply-bot.mjs                  // risponde solo ai trigger (default)
//   node scripts/reply-bot.mjs --all            // risponde a tutti i commenti non gestiti
//   node scripts/reply-bot.mjs --limit 5        // analizza solo gli ultimi N post (default 10)
//
