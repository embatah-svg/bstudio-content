...
// Uso:
//   node scripts/publish-instagram.mjs --tag tag01            // un post
//   node scripts/publish-instagram.mjs --all                  // tutti gli "status":"ready"
...
const ASSET_PREFIX = "projects/bstudio-social"; // percorso di questo progetto dentro il repo
const assetUrl = (rel) => `${(ASSET_BASE_URL || "https://ASSET_BASE_URL").replace(/\/$/, "")}/${ASSET_PREFIX}/${rel.replace(/\\/g, "/")}`;
