...
// Uso:
//   node scripts/reply-bot-loop.mjs              // poll ogni 10 minuti (default)
//   node scripts/reply-bot-loop.mjs --interval 5 // poll ogni 5 minuti
//   node scripts/reply-bot-loop.mjs --dry-run    // loop in dry-run (test)
//   Ctrl+C per fermare.
//
