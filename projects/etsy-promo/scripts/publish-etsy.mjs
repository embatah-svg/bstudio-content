...
// Uso: node scripts/publish-etsy.mjs [--dry-run] [--only=post,story]
...
const ASSET_PREFIX = "projects/etsy-promo"; // percorso di questo progetto dentro il repo
const assetUrl = (rel) => `${(ASSET_BASE_URL || "").replace(/\/$/, "")}/${ASSET_PREFIX}/${String(rel).replace(/\\/g, "/")}`;
...
const POST = {
  images: [
    "assets/E/01-hook.png",
    "assets/E/02-barbershop.png",
    "assets/E/03-salon.png",
    "assets/E/04-restaurant.png",
    "assets/E/05-included.png",
  ],
  caption:
...
const STORY = { video: "assets/etsy-g01-story.mp4" };
