...
// ---------- grundregeln (Runde 3) ----------
{ c:"grundregeln", q:{de:"Ein Ball rollt zwischen parkierten Autos auf die Fahrbahn.", ar:"كرة تتدحرج بين سيارات متوقفة إلى الطريق."}, a:[
  {de:"Sofort bremsbereit sein.", ar:"كن مستعداً للكبح فوراً."},{de:"Ein Kind könnte dem Ball unmittelbar hinterherlaufen.", ar:"قد يركض طفل خلف الكرة مباشرة."},{de:"Ein Ball allein ist kein Grund, die Geschwindigkeit anzupassen.", ar:"الكرة وحدها ليست سبباً لتعديل السرعة."}], correct:[0,1],
  e:{de:"Der Ball selbst ist harmlos, das Kind dahinter ist die eigentliche Gefahr.", ar:"الكرة نفسها غير خطيرة، الخطر الحقيقي هو الطفل خلفها."}, scene:"kinder_ball"},
{ c:"grundregeln", q:{de:"Du befährst eine signalisierte Fahrradstrasse mit dem Auto.", ar:"تسير بسيارتك في شارع مخصص للدراجات ومُشار إليه كذلك."}, a:[
  {de:"Motorfahrzeuge sind dort meist nur zu Gast.", ar:"المركبات الآلية غالباً ما تكون ضيفاً هناك فقط."},{de:"Rücksichtnahme auf Velofahrer hat besondere Priorität.", ar:"مراعاة راكبي الدراجات لها أولوية خاصة."},{de:"Auf einer Fahrradstrasse gelten für Autos genau dieselben Vorrechte wie auf jeder normalen Strasse.", ar:"على شارع الدراجات، للسيارات نفس الامتيازات تماماً كأي شارع عادي."}], correct:[0,1],
  e:{de:"Velofahrer dürfen dort nebeneinander fahren, Autos müssen sich anpassen.", ar:"يمكن لراكبي الدراجات السير جنباً إلى جنب هناك، وعلى السيارات التكيّف."}, scene:"fahrradstrasse"},
{ c:"grundregeln", q:{de:"Du siehst ein Fahrzeug, das offensichtlich in falscher Richtung auf der Autobahn unterwegs ist.", ar:"ترى مركبة تسير بوضوح في الاتجاه الخاطئ على الأوتوستراد."}, a:[
  {de:"Sofort Tempo reduzieren und weit rechts fahren.", ar:"خفّض السرعة فوراً وسِر أقصى اليمين."},{de:"Wenn möglich, die Polizei über die Notrufnummer informieren.", ar:"أبلغ الشرطة عبر رقم الطوارئ إن أمكن."},{de:"Selbst versuchen, das Fahrzeug zu stoppen oder zu überholen.", ar:"حاول بنفسك إيقاف المركبة أو تجاوزها."}], correct:[0,1],
  e:{de:"Ein Geisterfahrer ist eine der gefährlichsten Situationen auf der Autobahn überhaupt.", ar:"سائق بالاتجاه الخاطئ من أخطر المواقف على الأوتوستراد إطلاقاً."}, scene:"geisterfahrer"},
{ c:"grundregeln", q:{de:"Du fährst mit einem Mietfahrzeug, das du nicht gut kennst.", ar:"تقود مركبة مستأجرة لا تعرفها جيداً."}, a:[
  {de:"Vor der Fahrt Bedienelemente wie Licht, Blinker und Bremse kurz kennenlernen.", ar:"تعرّف بسرعة على عناصر التحكم كالإضاءة والغماز والفرامل قبل الانطلاق."},{de:"Ungewohnte Fahrzeuge können anfangs zu Fehlbedienungen führen.", ar:"قد تؤدي المركبات غير المألوفة إلى أخطاء تشغيل في البداية."},{de:"Ein Mietfahrzeug verhält sich garantiert exakt wie das eigene Auto.", ar:"تتصرف السيارة المستأجرة حتماً تماماً مثل سيارتك الخاصة."}], correct:[0,1],
  e:{de:"Wenige Minuten Vertrautmachen erhöhen die Sicherheit spürbar.", ar:"دقائق قليلة من التعرّف تزيد الأمان بشكل ملموس."}},
{ c:"grundregeln", q:{de:"Ein Beifahrer reicht dir während der Fahrt wiederholt Gegenstände und lenkt dich ab.", ar:"راكب يناولك أغراضاً بشكل متكرر أثناء القيادة ويشتت انتباهك."}, a:[
  {de:"Du darfst höflich bitten, damit bis zu einem Halt zu warten.", ar:"يمكنك أن تطلب بلطف الانتظار حتى التوقف."},{de:"Deine Aufmerksamkeit auf den Verkehr hat Vorrang.", ar:"انتباهك لحركة السير له الأولوية."},{de:"Solche Ablenkungen sind für die Fahrsicherheit ohne jede Bedeutung.", ar:"مثل هذا التشتت لا أهمية له إطلاقاً لسلامة القيادة."}], correct:[0,1],
  e:{de:"Auch kurze Blickabwendungen können in kritischen Momenten gefährlich sein.", ar:"حتى تحويل النظر لفترة قصيرة قد يكون خطيراً في اللحظات الحرجة."}},
{ c:"grundregeln", q:{de:"Auf einer enge Quartierstrasse ohne Trottoir gehen Fussgänger direkt am Fahrbahnrand.", ar:"يمشي المشاة مباشرة على حافة طريق ضيّق بحي سكني بلا رصيف."}, a:[
  {de:"Ausreichend seitlichen Abstand einhalten.", ar:"حافظ على مسافة جانبية كافية."},{de:"Tempo entsprechend anpassen.", ar:"كيّف السرعة وفقاً لذلك."},{de:"Fehlendes Trottoir hat auf die nötige Vorsicht keinen Einfluss.", ar:"غياب الرصيف ليس له تأثير على الحذر المطلوب."}], correct:[0,1],
  e:{de:"Ohne Trottoir ist der Abstand zu Fussgängern besonders wichtig.", ar:"بلا رصيف تكون المسافة عن المشاة مهمة بشكل خاص."}},
{ c:"grundregeln", q:{de:"Du bemerkst, dass ein anderes Fahrzeug dir sehr dicht auffährt.", ar:"تلاحظ أن مركبة أخرى تقترب منك جداً من الخلف."}, a:[
  {de:"Ruhig bleiben und nicht abrupt bremsen.", ar:"ابقَ هادئاً ولا تكبح بشكل مفاجئ."},{de:"Wenn möglich und sicher, das Fahrzeug vorbeilassen.", ar:"إذا أمكن وبأمان، اترك المركبة تمر."},{de:"Als Reaktion selbst noch dichter auf das Fahrzeug vor dir auffahren.", ar:"كرد فعل اقترب أنت أيضاً أكثر من المركبة أمامك."}], correct:[0,1],
  e:{de:"Provokation erhöht nur das gemeinsame Risiko.", ar:"الاستفزاز لا يزيد إلا الخطر المشترك."}},

// ---------- signale (Runde 3) ----------
{ c:"signale", q:{de:"An einer einspurigen Baustelle regelt eine provisorische Lichtsignalanlage den Verkehr.", ar:"عند أشغال بمسرب واحد، تنظّم إشارة ضوئية مؤقتة حركة السير."}, a:[
  {de:"Sie funktioniert wie eine normale Ampel.", ar:"تعمل مثل إشارة المرور العادية."},{de:"Bei Rot musst du zwingend anhalten, auch wenn die Strasse frei wirkt.", ar:"عند الأحمر عليك التوقف إلزامياً حتى لو بدا الطريق خالياً."},{de:"Provisorische Anlagen dürfen ignoriert werden.", ar:"يمكن تجاهل الأجهزة المؤقتة."}], correct:[0,1],
  e:{de:"Da nur eine Spur befahrbar ist, verhindert die Ampel Frontalzusammenstösse.", ar:"بما أن مسرباً واحداً فقط صالح للسير، تمنع الإشارة الاصطدامات الجبهية."}, scene:"baustelle_ampel"},
{ c:"signale", q:{de:"Ein Signal zeigt ein Warndreieck mit einer stark vereinfachten Zeichnung, die du nicht auf Anhieb erkennst.", ar:"إشارة مثلثة تُظهر رسماً مبسطاً جداً لا تتعرف عليه للوهلة الأولى."}, a:[
  {de:"Die Grundfarbe und Form geben trotzdem einen Hinweis auf eine Gefahr.", ar:"يعطي اللون والشكل الأساسيان رغم ذلك إشارة إلى وجود خطر."},{de:"Vorsichtiger fahren, bis die genaue Gefahr erkennbar wird.", ar:"قُد بحذر أكبر حتى يتضح الخطر بالتحديد."},{de:"Ein unbekanntes Symbol darf komplett ignoriert werden.", ar:"يمكن تجاهل رمز غير معروف تماماً."}], correct:[0,1],
  e:{de:"Form und Farbe eines Signals verraten oft schon die Grundbedeutung.", ar:"غالباً ما يكشف شكل الإشارة ولونها المعنى الأساسي حتى قبل فهم التفاصيل."}},
{ c:"signale", q:{de:"Auf der Fahrbahn sind grosse weisse Pfeile aufgemalt, die die vorgeschriebene Fahrtrichtung je Spur zeigen.", ar:"أسهم بيضاء كبيرة مرسومة على الطريق تُظهر الاتجاه الإلزامي لكل مسرب."}, a:[
  {de:"Du musst dich rechtzeitig in die passende Spur einordnen.", ar:"عليك الاندماج في المسرب المناسب في الوقت المناسب."},{de:"Ein späterer Spurwechsel gegen den Pfeil kann gefährlich und unzulässig sein.", ar:"تغيير المسرب المتأخر عكس اتجاه السهم قد يكون خطيراً وغير جائز."},{de:"Pfeile auf der Fahrbahn sind reine Dekoration ohne verbindliche Wirkung.", ar:"الأسهم على الطريق مجرد زخرفة بلا أي أثر ملزم."}], correct:[0,1],
  e:{de:"Solche Pfeile sind eine verbindliche Markierung, keine Empfehlung.", ar:"هذه الأسهم علامة ملزمة، وليست مجرد توصية."}},
{ c:"signale", q:{de:"Nachts erkennst du einen Fussgängerstreifen erst spät, weil die Beleuchtung schwach ist.", ar:"تتعرف على ممر مشاة متأخراً ليلاً بسبب ضعف الإنارة."}, a:[
  {de:"Bei schlechter Beleuchtung besonders aufmerksam auf Streifen und Fussgänger achten.", ar:"انتبه بشكل خاص للممرات والمشاة عند ضعف الإنارة."},{de:"Tempo an die eingeschränkte Sicht anpassen.", ar:"كيّف السرعة مع الرؤية المحدودة."},{de:"Nachts haben Fussgängerstreifen keine Gültigkeit mehr.", ar:"لا تسري ممرات المشاة ليلاً بعد الآن."}], correct:[0,1],
  e:{de:"Die Vortrittsregel am Streifen gilt unabhängig von der Tageszeit.", ar:"قاعدة الأولوية عند الممر سارية بصرف النظر عن وقت اليوم."}, scene:"fussgaengerstreifen_nacht"},
{ c:"signale", q:{de:"Ein rundes blaues Signal zeigt ein Fahrrad-Symbol zusammen mit einem Fussgänger-Symbol.", ar:"إشارة دائرية زرقاء تُظهر رمز دراجة مع رمز مشاة معاً."}, a:[
  {de:"Das kennzeichnet oft einen gemeinsam benutzten Rad- und Fussweg.", ar:"تُشير غالباً إلى مسار مشترك للدراجات والمشاة."},{de:"Gegenseitige Rücksichtnahme ist dort besonders wichtig.", ar:"المراعاة المتبادلة مهمة هناك بشكل خاص."},{de:"Ein solches Signal gilt ausschliesslich für Fussgänger.", ar:"تخص هذه الإشارة المشاة حصراً."}], correct:[0,1],
  e:{de:"Beide Symbole zusammen bedeuten, dass der Weg für beide Gruppen bestimmt ist.", ar:"يعني الرمزان معاً أن المسار مخصص لكلتا الفئتين."}},
{ c:"signale", q:{de:"An einer Kreuzung blinkt zusätzlich zur normalen Ampel ein gelbes Licht mit einem Pfeilsymbol für Rechtsabbieger.", ar:"عند تقاطع، بالإضافة إلى الإشارة العادية، يومض ضوء أصفر برمز سهم للمنعطفين يميناً."}, a:[
  {de:"Das kann ein zusätzliches, bedingtes Rechtsabbiegen erlauben.", ar:"قد يسمح ذلك بانعطاف يميني إضافي مشروط."},{de:"Auch dabei musst du Fussgängern und Velofahrern den Vortritt lassen.", ar:"حتى في هذه الحالة عليك منح الأولوية للمشاة وراكبي الدراجات."},{de:"Ein solches Zusatzlicht hebt automatisch alle anderen Vortrittsregeln auf.", ar:"يُلغي هذا الضوء الإضافي تلقائياً كل قواعد الأولوية الأخرى."}], correct:[0,1],
  e:{de:"Solche Zusatzsignale sind eine bedingte Erlaubnis, kein genereller Freibrief.", ar:"هذه الإشارات الإضافية إذن مشروط، لا تصريح عام مطلق."}},

// ---------- tempo (Runde 3) ----------
{ c:"tempo", q:{de:"Du fährst innerorts durch ein Gebiet, in dem viele Velofahrer unterwegs sind, ohne besonderes Tempolimit.", ar:"تسير داخل منطقة كثيفة براكبي الدراجات داخل المدينة، بلا حد سرعة خاص."}, a:[
  {de:"Auch bei erlaubten 50 km/h kann eine tiefere Geschwindigkeit angebracht sein.", ar:"حتى مع سرعة 50 كم/س المسموحة، قد تكون سرعة أقل مناسبة."},{de:"Grösserer Sicherheitsabstand zu Velofahrern ist sinnvoll.", ar:"مسافة أمان أكبر عن راكبي الدراجات أمر منطقي."},{de:"Die signalisierte Höchstgeschwindigkeit ist in jedem Fall automatisch auch die sicherste Wahl.", ar:"السرعة القصوى المشار إليها هي دائماً وتلقائياً الخيار الأكثر أماناً."}], correct:[0,1],
  e:{de:"Die Grundregel verlangt eine Anpassung an die tatsächlichen Verhältnisse.", ar:"القاعدة الأساسية تتطلب التكيّف مع الظروف الفعلية."}},
{ c:"tempo", q:{de:"Du fährst mit 130 km/h auf einem Autobahnabschnitt, wo 120 km/h erlaubt sind.", ar:"تقود بسرعة 130 كم/س على مقطع أوتوستراد يُسمح فيه بـ120 كم/س."}, a:[
  {de:"Das ist eine Geschwindigkeitsüberschreitung.", ar:"هذا تجاوز للسرعة المسموحة."},{de:"Der Bremsweg verlängert sich gegenüber der erlaubten Geschwindigkeit zusätzlich.", ar:"تطول مسافة الكبح إضافياً مقارنة بالسرعة المسموحة."},{de:"Bis 10 km/h über dem Limit sind auf der Autobahn grundsätzlich toleriert und erlaubt.", ar:"حتى 10 كم/س فوق الحد مسموحة ومتساهل معها أصلاً على الأوتوستراد."}], correct:[0,1],
  e:{de:"Jede Überschreitung der Höchstgeschwindigkeit ist eine Widerhandlung, unabhängig vom Ausmass.", ar:"أي تجاوز للسرعة القصوى مخالفة، بصرف النظر عن مقداره."}},
{ c:"tempo", q:{de:"Du siehst weit vor dir am Fahrbahnrand ein Schild «Stauende», ohne den Stau selbst schon zu sehen.", ar:"ترى بعيداً أمامك على حافة الطريق لوحة «نهاية ازدحام» دون أن ترى الازدحام نفسه بعد."}, a:[
  {de:"Vorsorglich das Tempo reduzieren.", ar:"خفّض السرعة احترازياً."},{de:"Auf plötzlich stehende Fahrzeuge gefasst sein.", ar:"كن مستعداً لمركبات متوقفة فجأة."},{de:"Ein solches Schild ist unverbindlich und kann ignoriert werden.", ar:"مثل هذه اللوحة غير ملزمة ويمكن تجاهلها."}], correct:[0,1],
  e:{de:"Warnhinweise vor Stau erscheinen oft, bevor der Stau selbst sichtbar wird.", ar:"غالباً ما تظهر تحذيرات الازدحام قبل أن يصبح الازدحام نفسه مرئياً."}, scene:"stauende_autobahn"},
{ c:"tempo", q:{de:"Du bist mit einem sehr leichten, wendigen Fahrzeug unterwegs und fühlst dich bei hoher Geschwindigkeit sicher.", ar:"تقود مركبة خفيفة جداً وسهلة المناورة وتشعر بالأمان عند سرعة عالية."}, a:[
  {de:"Das subjektive Sicherheitsgefühl entspricht nicht immer der objektiven Physik.", ar:"الشعور الذاتي بالأمان لا يطابق دائماً حقائق الفيزياء الموضوعية."},{de:"Bremsweg und Anhalteweg gelten unabhängig vom Fahrzeuggefühl.", ar:"تنطبق مسافتا الكبح والتوقف بصرف النظر عن شعورك تجاه المركبة."},{de:"Leichte Fahrzeuge haben grundsätzlich einen kürzeren Bremsweg als schwere.", ar:"للمركبات الخفيفة أصلاً مسافة كبح أقصر من الثقيلة دائماً."}], correct:[0,1],
  e:{de:"Reifenhaftung und Geschwindigkeit bestimmen den Bremsweg, nicht das subjektive Gefühl.", ar:"تماسك الإطارات والسرعة هما ما يحددان مسافة الكبح، لا الشعور الذاتي."}},
{ c:"tempo", q:{de:"An einer Stelle mit häufigem Wildwechsel zeigt ein Signal eine reduzierte Geschwindigkeit, besonders in der Dämmerung.", ar:"في مكان يكثر فيه عبور الحيوانات البرية، تُظهر إشارة سرعة مخفضة، خاصة عند الغسق."}, a:[
  {de:"Dieses Limit unbedingt einhalten.", ar:"التزم بهذا الحد إلزامياً."},{de:"In der Dämmerung ist die Gefahr eines plötzlichen Wildwechsels höher.", ar:"يزداد خطر عبور الحيوانات المفاجئ عند الغسق."},{de:"Wildwechsel-Signale betreffen nur die Nacht, tagsüber gilt das normale Limit.", ar:"تخص إشارات عبور الحيوانات الليل فقط، ونهاراً يسري الحد العادي."}], correct:[0,1],
  e:{de:"Auch tagsüber, besonders in Waldnähe, können Tiere unerwartet auftauchen.", ar:"حتى نهاراً، خاصة قرب الغابات، قد تظهر الحيوانات فجأة."}},
{ c:"tempo", q:{de:"Du überholst ein Fahrzeug ausserorts, dein Tacho zeigt kurzzeitig deutlich mehr als erlaubt.", ar:"تتجاوز مركبة خارج المدينة، ويُظهر عدادك للحظة سرعة أعلى بكثير من المسموح."}, a:[
  {de:"Auch beim Überholen gilt die signalisierte Höchstgeschwindigkeit.", ar:"حتى أثناء التجاوز، تسري السرعة القصوى المُشار إليها."},{de:"Ein Überholmanöver rechtfertigt keine Geschwindigkeitsüberschreitung.", ar:"مناورة التجاوز لا تبرر تجاوز حد السرعة."},{de:"Beim Überholen darf die Höchstgeschwindigkeit kurzzeitig frei überschritten werden.", ar:"يمكن تجاوز الحد الأقصى للسرعة بحرية لفترة قصيرة أثناء التجاوز."}], correct:[0,1],
  e:{de:"Ein Überholvorgang sollte von Anfang an so geplant sein, dass er im erlaubten Tempo möglich ist.", ar:"يجب التخطيط لعملية التجاوز منذ البداية بحيث تكون ممكنة ضمن السرعة المسموحة."}},

// ---------- vortritt (Runde 3) ----------
{ c:"vortritt", q:{de:"Du willst nach links abbiegen, während Gegenverkehr naht, der seinerseits nach rechts in dieselbe Strasse abbiegen will.", ar:"تريد الانعطاف يساراً بينما يقترب سير مقابل يريد بدوره الانعطاف يميناً إلى نفس الطريق."}, a:[
  {de:"Du musst dem Gegenverkehr weiterhin den Vortritt lassen.", ar:"عليك رغم ذلك منح الأولوية للسير المقابل."},{de:"Beide Fahrzeuge können oft gleichzeitig sicher abbiegen, wenn die Situation klar ist.", ar:"غالباً ما يمكن للمركبتين الانعطاف بأمان في آن واحد إذا كان الموقف واضحاً."},{de:"Rechtsabbieger aus der Gegenrichtung haben automatisch Vortritt vor dir.", ar:"للمنعطفين يميناً من الاتجاه المقابل الأولوية تلقائياً عليك."}], correct:[0,1],
  e:{de:"Blickkontakt und eindeutiges Verhalten helfen, solche Situationen sicher zu lösen.", ar:"التواصل بالنظر والتصرف الواضح يساعدان على حل هذه المواقف بأمان."}, scene:"linksabbiegen_gegenverkehr"},
{ c:"vortritt", q:{de:"Ein Fahrradstreifen endet abrupt kurz vor einer Kreuzung, ein Velofahrer muss sich in den Autoverkehr einordnen.", ar:"ينتهي مسرب الدراجات فجأة قبل تقاطع، ويجب على راكب الدراجة الاندماج مع سير السيارات."}, a:[
  {de:"Dem Velofahrer beim Einordnen Platz lassen.", ar:"اترك مجالاً لراكب الدراجة عند اندماجه."},{de:"Er befindet sich in einer schwierigen, verletzlichen Position.", ar:"هو في موقف صعب وضعيف الحماية."},{de:"Velofahrer müssen sich in dieser Situation immer komplett unterordnen und warten.", ar:"يجب على راكب الدراجة دائماً التنازل الكامل والانتظار في هذا الموقف."}], correct:[0,1],
  e:{de:"Gegenseitige Rücksicht verhindert hier die meisten Unfälle.", ar:"المراعاة المتبادلة تمنع معظم الحوادث هنا."}},
{ c:"vortritt", q:{de:"An einer Verzweigung mit Rechtsvortritt naht von rechts ein sehr langsames landwirtschaftliches Fahrzeug.", ar:"عند تقاطع بأولوية اليمين، تقترب من اليمين مركبة زراعية بطيئة جداً."}, a:[
  {de:"Der Rechtsvortritt gilt unabhängig von der Geschwindigkeit des Fahrzeugs.", ar:"أولوية اليمين سارية بصرف النظر عن سرعة المركبة."},{de:"Geduldig abwarten, auch wenn es länger dauert.", ar:"انتظر بصبر حتى لو استغرق الأمر وقتاً أطول."},{de:"Bei besonders langsamen Fahrzeugen darfst du den Vortritt ausnahmsweise übernehmen.", ar:"يمكنك استثنائياً أخذ الأولوية مع المركبات البطيئة جداً."}], correct:[0,1],
  e:{de:"Die Regel unterscheidet nicht nach Fahrzeugtyp oder Tempo.", ar:"لا تُميّز القاعدة حسب نوع المركبة أو سرعتها."}},
{ c:"vortritt", q:{de:"Ein Rettungswagen mit Blaulicht nähert sich einer roten Ampel aus der Querstrasse.", ar:"سيارة إسعاف بضوء أزرق تقترب من إشارة حمراء من الطريق العرضي."}, a:[
  {de:"Auch bei Grün für dich mit besonderer Vorsicht an die Kreuzung heranfahren.", ar:"اقترب من التقاطع بحذر خاص حتى لو كانت إشارتك خضراء."},{de:"Einsatzfahrzeuge können die Kreuzung trotz Rot für sie durchfahren.", ar:"يمكن لمركبات الطوارئ عبور التقاطع رغم الأحمر بالنسبة لها."},{de:"Ein grünes Licht für dich bedeutet, dass du dich um Einsatzfahrzeuge nicht kümmern musst.", ar:"الضوء الأخضر لك يعني أنه لا داعي للاهتمام بمركبات الطوارئ."}], correct:[0,1],
  e:{de:"Sirene und Blaulicht heben die normale Ampelregelung für das Einsatzfahrzeug auf.", ar:"تُلغي الصفارة والضوء الأزرق تنظيم الإشارة العادي بالنسبة لمركبة الطوارئ."}},
{ c:"vortritt", q:{de:"Du fährst aus einer Nebenstrasse und siehst einen Fussgänger, der bereits auf der Fahrbahn steht, obwohl kein Streifen vorhanden ist.", ar:"تخرج من طريق فرعي وترى مشاة يقف بالفعل على الطريق رغم عدم وجود ممر."}, a:[
  {de:"Du darfst niemanden gefährden, unabhängig vom formalen Vortritt.", ar:"لا يجوز تعريض أحد للخطر بصرف النظر عن الأولوية الشكلية."},{de:"Nötigenfalls anhalten und die Person passieren lassen.", ar:"توقف عند الحاجة واترك الشخص يمر."},{de:"Ohne Streifen darfst du einfach weiterfahren, egal wo die Person steht.", ar:"بلا ممر يمكنك المتابعة ببساطة بصرف النظر عن مكان الشخص."}], correct:[0,1],
  e:{de:"Die Grundregel steht über jeder formalen Vortrittsfrage.", ar:"القاعدة الأساسية تعلو على أي مسألة أولوية شكلية."}},
{ c:"vortritt", q:{de:"Zwei Autos nähern sich gleichzeitig einem Kreisel aus verschiedenen Richtungen, keines ist bereits drin.", ar:"سيارتان تقتربان في آن واحد من دوّار من اتجاهين مختلفين، ولا واحدة منهما داخله بعد."}, a:[
  {de:"Beide müssen dem bereits im Kreisel befindlichen Verkehr Vortritt lassen.", ar:"على كليهما منح الأولوية للسير الموجود بالفعل داخل الدوّار."},{de:"Untereinander gilt beim Einfahren keine feste Reihenfolge, Vorsicht ist gefragt.", ar:"لا يوجد ترتيب ثابت بينهما عند الدخول، والحذر مطلوب."},{de:"Wer zuerst hupt, darf zuerst einfahren.", ar:"من يستعمل البوق أولاً يدخل أولاً."}], correct:[0,1],
  e:{de:"Entscheidend ist immer der Verkehr, der bereits im Kreisel ist.", ar:"الحاسم دائماً هو السير الموجود بالفعل داخل الدوّار."}},
{ c:"vortritt", q:{de:"Auf einer Hauptstrasse näherst du dich einer unbedeutenden Feldeinfahrt ohne jedes Signal.", ar:"على طريق رئيسي تقترب من مدخل حقل غير مهم بلا أي إشارة."}, a:[
  {de:"Fahrzeuge aus der Feldeinfahrt haben dir gegenüber keinen Vortritt.", ar:"ليس للمركبات الخارجة من مدخل الحقل أولوية تجاهك."},{de:"Trotzdem ist Aufmerksamkeit sinnvoll, falls sich jemand nicht korrekt verhält.", ar:"رغم ذلك الانتباه منطقي في حال لم يتصرف أحد بشكل صحيح."},{de:"Als Hauptstrassenbenutzer musst du an jeder Einmündung vollständig anhalten.", ar:"بصفتك على الطريق الرئيسي عليك التوقف التام عند كل مدخل."}], correct:[0,1],
  e:{de:"Dein Vortritt entbindet dich nie ganz von der Grundregel.", ar:"أولويتك لا تُعفيك أبداً بشكل كامل من القاعدة الأساسية."}},
{ c:"vortritt", q:{de:"Ein Motorradfahrer nähert sich sehr schnell einer Kreuzung, an der du eigentlich Vortritt hast.", ar:"دراجة نارية تقترب بسرعة كبيرة من تقاطع لك فيه الأولوية أصلاً."}, a:[
  {de:"Formaler Vortritt schützt nicht vor einem zu schnellen Fahrzeug.", ar:"الأولوية الشكلية لا تحمي من مركبة تسير بسرعة مفرطة."},{de:"Im Zweifel lieber kurz warten, statt auf dem Vortritt zu bestehen.", ar:"عند الشك من الأفضل الانتظار قليلاً بدل التمسك بالأولوية."},{de:"Du darfst und sollst in jedem Fall auf deinem Vortritt bestehen.", ar:"يمكنك بل ويجب عليك التمسك بأولويتك في كل الأحوال."}], correct:[0,1],
  e:{de:"Die Grundregel, niemanden zu gefährden, geht immer vor dem formalen Recht.", ar:"القاعدة الأساسية بعدم تعريض أحد للخطر تسبق دائماً الحق الشكلي."}},

// ---------- manoever (Runde 3) ----------
{ c:"manoever", q:{de:"Du willst auf einer engen Strasse an einem haltenden Bus vorbeifahren, der keine Warnblinker zeigt.", ar:"تريد المرور بجانب حافلة متوقفة على طريق ضيّق بلا تشغيل أضواء تحذير."}, a:[
  {de:"Trotzdem mit Fahrgästen rechnen, die aussteigen könnten.", ar:"توقّع رغم ذلك ركاباً قد ينزلون."},{de:"Langsam und mit Abstand vorbeifahren.", ar:"مُر ببطء وبمسافة كافية."},{de:"Ohne Warnblinker besteht garantiert keinerlei besonderes Risiko.", ar:"بلا أضواء تحذير لا يوجد أي خطر خاص مضمون."}], correct:[0,1],
  e:{de:"Fahrgäste können auch ohne aktivierte Warnblinker plötzlich aussteigen.", ar:"قد ينزل الركاب فجأة حتى بلا تفعيل أضواء التحذير."}},
{ c:"manoever", q:{de:"Beim Rückwärtseinparken in eine Parklücke zwischen zwei Fahrzeugen wird die Sicht zunehmend eingeschränkt.", ar:"عند الركن للخلف بين مركبتين تتناقص الرؤية تدريجياً."}, a:[
  {de:"Rückspiegel und wenn möglich Rückfahrkamera nutzen.", ar:"استخدم المرآة الخلفية وكاميرا الرجوع إن أمكن."},{de:"Bei stark eingeschränkter Sicht das Fahrzeug notfalls verlassen, um nachzusehen.", ar:"عند انعدام الرؤية بشدة، انزل من المركبة عند الحاجة للتأكد."},{de:"Technische Hilfsmittel ersetzen jede Notwendigkeit, selbst nachzusehen.", ar:"الوسائل التقنية تُغني تماماً عن ضرورة التأكد بنفسك."}], correct:[0,1],
  e:{de:"Kameras und Sensoren haben technische Grenzen und tote Winkel.", ar:"للكاميرات والحساسات حدود تقنية ونقاط عمياء."}},
{ c:"manoever", q:{de:"Du willst auf einer Standspur, die dynamisch für den Verkehr freigegeben wurde, wieder auf die reguläre Spur wechseln.", ar:"تريد العودة إلى المسرب العادي من شريط طوارئ فُتح مؤقتاً للسير."}, a:[
  {de:"Beim Spurwechsel gelten dieselben Regeln wie sonst: Spiegel, Blinker, Schulterblick.", ar:"تنطبق عند تغيير المسرب نفس القواعد المعتادة: المرآة، الغماز، النظرة فوق الكتف."},{de:"Rechtzeitig einordnen, bevor die Freigabe endet.", ar:"اندمج في الوقت المناسب قبل انتهاء الفتح المؤقت."},{de:"Eine dynamisch freigegebene Spur erfordert keinerlei besondere Vorsicht.", ar:"لا يتطلب المسرب المفتوح ديناميكياً أي حذر خاص."}], correct:[0,1],
  e:{de:"Solche Spuren enden oft abrupt an einer bestimmten Stelle.", ar:"غالباً ما تنتهي هذه المسارب فجأة عند نقطة معينة."}},
{ c:"manoever", q:{de:"Beim Überholen eines langsamen Traktors auf einer Landstrasse ist die Sicht durch eine leichte Kuppe eingeschränkt.", ar:"عند تجاوز جرار بطيء على طريق ريفي، الرؤية محدودة بسبب قمة تلة خفيفة."}, a:[
  {de:"Bei eingeschränkter Sicht auf den Überholvorgang verzichten.", ar:"تخلَّ عن التجاوز عند محدودية الرؤية."},{de:"Warten, bis die Strecke wirklich vollständig einsehbar ist.", ar:"انتظر حتى يصبح المقطع مرئياً بالكامل فعلاً."},{de:"Ein langsamer Traktor rechtfertigt ein Überholen auch bei knapper Sicht.", ar:"الجرار البطيء يبرر التجاوز حتى مع رؤية ضيقة."}], correct:[0,1],
  e:{de:"Die Ungeduld gegenüber langsamen Fahrzeugen führt zu vielen Frontalunfällen.", ar:"نفاد الصبر تجاه المركبات البطيئة يسبب كثيراً من الحوادث الجبهية."}},
{ c:"manoever", q:{de:"Du willst wenden auf einer Strasse mit Sicherheitslinie in der Mitte.", ar:"تريد الاستدارة على طريق بخط أمان في الوسط."}, a:[
  {de:"Über eine durchgezogene Linie darfst du dafür nicht fahren.", ar:"لا يجوز عبور الخط المتصل من أجل ذلك."},{de:"Eine geeignete Stelle ohne Sicherheitslinie suchen.", ar:"ابحث عن مكان مناسب بلا خط أمان."},{de:"Zum Wenden darf die Sicherheitslinie ausnahmsweise überfahren werden.", ar:"يجوز استثنائياً عبور خط الأمان من أجل الاستدارة."}], correct:[0,1],
  e:{de:"Die Sicherheitslinie kennt keine Ausnahme fürs Wenden.", ar:"لا يعرف خط الأمان أي استثناء من أجل الاستدارة."}},
{ c:"manoever", q:{de:"An einer Kreuzung mit mehreren Rechtsabbiegespuren willst du auf die äusserste rechte Spur wechseln.", ar:"عند تقاطع بعدة مسارب انعطاف يميني، تريد الانتقال إلى المسرب الأيمن الأقصى."}, a:[
  {de:"Rechtzeitig blinken und den toten Winkel kontrollieren.", ar:"استعمل الغماز مبكراً وتحقق من النقطة العمياء."},{de:"Auf Velofahrer im rechten Bereich besonders achten.", ar:"انتبه بشكل خاص لراكبي الدراجات في المنطقة اليمنى."},{de:"Auf mehrspurigen Abbiegespuren sind Velofahrer grundsätzlich nicht zu erwarten.", ar:"لا يُتوقع وجود راكبي دراجات أصلاً في مسارب الانعطاف المتعددة."}], correct:[0,1],
  e:{de:"Velofahrer fahren oft rechts neben abbiegenden Fahrzeugen, was ein erhöhtes Risiko schafft.", ar:"غالباً ما يسير راكبو الدراجات يمين المركبات المنعطفة، ما يخلق خطراً أكبر."}},
{ c:"manoever", q:{de:"Du parkierst dein Fahrzeug an einem Hang mit Blick zur Talseite.", ar:"تركن مركبتك على منحدر مواجه للجهة السفلى للوادي."}, a:[
  {de:"Die Räder in Richtung Bordstein oder Strassenrand einschlagen.", ar:"وجّه العجلات نحو الرصيف أو حافة الطريق."},{de:"Zusätzlich die Handbremse anziehen und einen Gang einlegen.", ar:"اشدّ فرملة اليد إضافياً وأدرِج غياراً."},{de:"Am Hang reicht es, einfach nur die Handbremse zu betätigen.", ar:"يكفي على المنحدر تفعيل فرملة اليد فقط."}], correct:[0,1],
  e:{de:"Mehrere Sicherungen zusammen verhindern ein Wegrollen zuverlässiger.", ar:"عدة إجراءات أمان معاً تمنع الانزلاق بشكل أكثر موثوقية."}},

// ---------- autobahn (Runde 3) ----------
{ c:"autobahn", q:{de:"Du fährst mit konstantem Tempo auf der mittleren Spur einer dreispurigen Autobahn, obwohl rechts durchgehend frei ist.", ar:"تقود بسرعة ثابتة على المسرب الأوسط لأوتوستراد ثلاثي المسارب رغم خلوّ اليمين باستمرار."}, a:[
  {de:"Das widerspricht dem Rechtsfahrgebot.", ar:"هذا يخالف وجوب السير يميناً."},{de:"Andere Fahrzeuge werden dadurch unnötig zum Spurwechsel gezwungen.", ar:"يُجبر ذلك مركبات أخرى بلا داعٍ على تغيير المسرب."},{de:"Auf einer dreispurigen Autobahn darf die mittlere Spur beliebig dauerhaft benutzt werden.", ar:"يمكن استخدام المسرب الأوسط بشكل دائم وحر على أوتوستراد ثلاثي المسارب."}], correct:[0,1],
  e:{de:"Auch bei drei Spuren gilt: möglichst weit rechts, ausser zum Überholen.", ar:"حتى مع ثلاثة مسارب: السير أقصى اليمين ما أمكن، إلا للتجاوز."}},
{ c:"autobahn", q:{de:"Bei einer Autobahnbaustelle wird der Verkehr auf eine einzige, sehr schmale Spur verengt.", ar:"عند أشغال على الأوتوستراد يُضيَّق السير إلى مسرب واحد ضيّق جداً."}, a:[
  {de:"Tempo deutlich reduzieren.", ar:"خفّض السرعة كثيراً."},{de:"Ausreichend Abstand zum Fahrzeug vor dir halten.", ar:"حافظ على مسافة كافية عن المركبة أمامك."},{de:"Die normale Höchstgeschwindigkeit bleibt in Baustellen unverändert gültig.", ar:"تبقى السرعة القصوى العادية سارية دون تغيير في مناطق الأشغال."}], correct:[0,1],
  e:{de:"In Baustellen gilt in der Regel eine speziell signalisierte, tiefere Höchstgeschwindigkeit.", ar:"عادة تسري في مناطق الأشغال سرعة قصوى مخفضة مُشار إليها خصيصاً."}},
{ c:"autobahn", q:{de:"Auf der Autobahn siehst du im Rückspiegel ein sich sehr schnell näherndes Fahrzeug auf der Überholspur.", ar:"ترى في المرآة الخلفية مركبة تقترب بسرعة كبيرة جداً على مسرب التجاوز."}, a:[
  {de:"Nicht selbst noch auf diese Spur wechseln.", ar:"لا تنتقل أنت أيضاً إلى هذا المسرب."},{de:"Wenn möglich, rechtzeitig nach rechts einordnen.", ar:"اندمج يميناً في الوقت المناسب إن أمكن."},{de:"Ein schnelles Fahrzeug von hinten hat kein Recht auf besondere Rücksicht.", ar:"ليس للمركبة السريعة من الخلف أي حق في مراعاة خاصة."}], correct:[0,1],
  e:{de:"Vorausschauendes Reagieren verhindert gefährliche Situationen bei hohen Geschwindigkeitsunterschieden.", ar:"التفاعل الاستباقي يمنع المواقف الخطيرة عند فروق السرعة الكبيرة."}},
{ c:"autobahn", q:{de:"Du fährst bei sommerlicher Hitze über eine lange Autobahnstrecke, die Klimaanlage läuft auf voller Stufe.", ar:"تقود مسافة طويلة على الأوتوستراد في حر الصيف، والمكيّف يعمل بأقصى درجة."}, a:[
  {de:"Regelmässige Trinkpausen bleiben trotzdem wichtig.", ar:"تبقى استراحات الشرب المنتظمة مهمة رغم ذلك."},{de:"Hitze und Klimaanlage können zusätzlich ermüden.", ar:"قد يزيد الحر والمكيّف من التعب إضافياً."},{de:"Eine laufende Klimaanlage macht Pausen auf langen Fahrten überflüssig.", ar:"تشغيل المكيّف يُغني عن الاستراحات في الرحلات الطويلة."}], correct:[0,1],
  e:{de:"Auch bei angenehmer Innentemperatur bleibt die 2-Stunden-Pausenregel sinnvoll.", ar:"حتى مع درجة حرارة داخلية مريحة تبقى قاعدة الاستراحة كل ساعتين منطقية."}},

// ---------- mensch (Runde 3) ----------
{ c:"mensch", q:{de:"Du fährst früh morgens nach einer sehr kurzen Nacht zur Arbeit.", ar:"تقود إلى العمل في الصباح الباكر بعد ليلة نوم قصيرة جداً."}, a:[
  {de:"Schlafmangel wirkt ähnlich wie Alkohol auf Reaktion und Konzentration.", ar:"قلة النوم تؤثر على رد الفعل والتركيز بشكل مشابه للكحول."},{de:"Bei starker Müdigkeit lieber eine Alternative zum Selbstfahren suchen.", ar:"عند التعب الشديد من الأفضل البحث عن بديل للقيادة بنفسك."},{de:"Ein starker Kaffee macht Schlafmangel vollständig wett.", ar:"القهوة القوية تعوّض قلة النوم بشكل كامل."}], correct:[0,1],
  e:{de:"Koffein wirkt nur kurzzeitig und ersetzt echten Schlaf nicht.", ar:"الكافيين يعمل لفترة قصيرة فقط ولا يُعوّض النوم الحقيقي."}},
{ c:"mensch", q:{de:"Du bist auf dem Weg zu einem wichtigen Termin spät dran und spürst Zeitdruck.", ar:"أنت متأخر في طريقك إلى موعد مهم وتشعر بضغط الوقت."}, a:[
  {de:"Zeitdruck verleitet oft zu riskanteren Entscheidungen.", ar:"غالباً ما يدفع ضغط الوقت إلى قرارات أكثر خطورة."},{de:"Lieber den Termin telefonisch verschieben, als das Risiko zu erhöhen.", ar:"من الأفضل تأجيل الموعد هاتفياً بدل زيادة الخطر."},{de:"Zeitdruck ist ein legitimer Grund, die Verkehrsregeln grosszügiger auszulegen.", ar:"ضغط الوقت سبب مشروع لتفسير قواعد المرور بمرونة أكبر."}], correct:[0,1],
  e:{de:"Wenige Minuten Verspätung wiegen weniger schwer als ein Unfallrisiko.", ar:"بضع دقائق تأخير أهون بكثير من خطر وقوع حادث."}},
{ c:"mensch", q:{de:"Du nimmst rezeptfreie Schmerzmittel gegen Kopfschmerzen und musst danach fahren.", ar:"تتناول مسكّناً بلا وصفة لألم الرأس وعليك القيادة بعده."}, a:[
  {de:"Manche Schmerzmittel können ebenfalls müde machen.", ar:"بعض المسكنات قد تسبب النعاس أيضاً."},{de:"Den Beipackzettel auf Warnhinweise zum Fahren prüfen.", ar:"تحقق من النشرة الداخلية بحثاً عن تحذيرات بخصوص القيادة."},{de:"Rezeptfreie Mittel haben nie irgendeinen Einfluss auf die Fahrtüchtigkeit.", ar:"الأدوية بلا وصفة ليس لها أي تأثير أبداً على اللياقة للقيادة."}], correct:[0,1],
  e:{de:"«Rezeptfrei» bedeutet nicht automatisch «ohne jede Nebenwirkung».", ar:"«بلا وصفة» لا يعني تلقائياً «بلا أي أثر جانبي»."}},
{ c:"mensch", q:{de:"Ein Beifahrer bittet dich während der Fahrt eindringlich, schneller zu fahren.", ar:"يطلب منك راكب بإلحاح أثناء القيادة أن تسرّع."}, a:[
  {de:"Die Verantwortung für die Geschwindigkeit liegt allein beim Fahrzeugführer.", ar:"مسؤولية السرعة تقع على السائق وحده."},{de:"Sozialer Druck ist kein gültiger Grund für zu hohes Tempo.", ar:"الضغط الاجتماعي ليس سبباً وجيهاً للسرعة الزائدة."},{de:"Auf ausdrücklichen Wunsch der Mitfahrenden darfst du das Limit überschreiten.", ar:"يمكنك تجاوز الحد بناءً على طلب صريح من الركاب."}], correct:[0,1],
  e:{de:"Du trägst die rechtliche Verantwortung, nicht die Mitfahrenden.", ar:"أنت من يتحمل المسؤولية القانونية، لا الركاب."}},
{ c:"mensch", q:{de:"Du fährst zum ersten Mal eine sehr lange Strecke allein und bist dir deiner Ausdauer nicht sicher.", ar:"تقود لأول مرة مسافة طويلة جداً بمفردك ولست متأكداً من قدرتك على التحمّل."}, a:[
  {de:"Pausen frühzeitig und grosszügig einplanen.", ar:"خطّط لاستراحات مبكرة وسخية."},{de:"Auf erste Anzeichen von Müdigkeit besonders achten.", ar:"انتبه بشكل خاص لأولى علامات التعب."},{de:"Ausdauer beim Fahren ist bei jedem Menschen automatisch identisch.", ar:"القدرة على التحمّل أثناء القيادة متطابقة تلقائياً عند الجميع."}], correct:[0,1],
  e:{de:"Realistische Selbsteinschätzung verhindert gefährliche Übermüdung.", ar:"التقييم الذاتي الواقعي يمنع الإرهاق الخطير."}},

// ---------- fahrzeug (Runde 3) ----------
{ c:"fahrzeug", q:{de:"Beim Anfahren am Morgen bemerkst du ein ungewöhnliches Geräusch aus dem Bremsbereich.", ar:"عند الانطلاق صباحاً تلاحظ صوتاً غير معتاد من منطقة الفرامل."}, a:[
  {de:"Ungewöhnliche Geräusche können auf Verschleiss oder einen Defekt hinweisen.", ar:"قد تُشير الأصوات غير المعتادة إلى تآكل أو عطل."},{de:"Im Zweifel eine Fachwerkstatt konsultieren.", ar:"استشر ورشة متخصصة عند الشك."},{de:"Geräusche bei den Bremsen sind grundsätzlich immer harmlos.", ar:"أصوات الفرامل غير مقلقة أصلاً دائماً."}], correct:[0,1],
  e:{de:"Bremsen gehören zu den sicherheitsrelevantesten Bauteilen überhaupt.", ar:"الفرامل من أهم الأجزاء المتعلقة بالسلامة على الإطلاق."}},
{ c:"fahrzeug", q:{de:"Die Windschutzscheibe hat einen kleinen Steinschlag direkt im Sichtfeld des Fahrers.", ar:"لوحة الزجاج الأمامي بها ضربة حجر صغيرة مباشرة في مجال رؤية السائق."}, a:[
  {de:"Ein Sprung im Sichtfeld kann die Sicht gefährlich beeinträchtigen.", ar:"قد يُضعف كسر في مجال الرؤية الرؤية بشكل خطير."},{de:"Reparatur oder Austausch möglichst rasch veranlassen.", ar:"رتّب للإصلاح أو الاستبدال بأسرع وقت ممكن."},{de:"Kleine Steinschläge dürfen ohne Weiteres dauerhaft ignoriert werden.", ar:"يمكن تجاهل ضربات الحجر الصغيرة نهائياً بلا مشكلة."}], correct:[0,1],
  e:{de:"Ein kleiner Schaden kann sich zudem durch Temperaturschwankungen schnell vergrössern.", ar:"قد يتضخم الضرر الصغير بسرعة بسبب تقلبات درجة الحرارة."}},
{ c:"fahrzeug", q:{de:"Du bemerkst starken Ölgeruch im Fahrzeuginnenraum während der Fahrt.", ar:"تلاحظ رائحة زيت قوية داخل المركبة أثناء القيادة."}, a:[
  {de:"Das kann auf ein technisches Problem hinweisen.", ar:"قد يُشير ذلك إلى مشكلة تقنية."},{de:"Möglichst bald sicher anhalten und die Ursache prüfen lassen.", ar:"توقف بأمان في أقرب وقت واطلب فحص السبب."},{de:"Ungewöhnliche Gerüche im Innenraum sind für die Sicherheit grundsätzlich unbedeutend.", ar:"الروائح غير المعتادة داخل المقصورة غير مهمة أصلاً للسلامة."}], correct:[0,1],
  e:{de:"Öl- oder Rauchgeruch kann im Extremfall auf eine Brandgefahr hindeuten.", ar:"قد تُشير رائحة الزيت أو الدخان في الحالات القصوى إلى خطر حريق."}, scene:"armaturenbrett"},
{ c:"fahrzeug", q:{de:"Ein neues Fahrzeug hat ein Fahrassistenzsystem, das automatisch bremsen kann.", ar:"لمركبتك الجديدة نظام مساعدة قيادة يمكنه الكبح تلقائياً."}, a:[
  {de:"Solche Systeme sind eine Unterstützung, keine vollständige Ersatzlösung für Aufmerksamkeit.", ar:"هذه الأنظمة مساعدة، وليست بديلاً كاملاً عن الانتباه."},{de:"Die Fahrperson bleibt weiterhin für die sichere Fahrt verantwortlich.", ar:"يبقى السائق مسؤولاً عن سلامة القيادة رغم ذلك."},{de:"Mit einem solchen System darf man sich vollständig auf die Technik verlassen und unaufmerksam sein.", ar:"مع مثل هذا النظام يمكن الاعتماد كلياً على التقنية والتغافل عن الانتباه."}], correct:[0,1],
  e:{de:"Assistenzsysteme können versagen oder Situationen falsch einschätzen.", ar:"قد تفشل أنظمة المساعدة أو تُخطئ في تقدير المواقف."}},
{ c:"fahrzeug", q:{de:"Du fährst regelmässig mit stark verschmutzten Scheinwerfern.", ar:"تقود بانتظام بمصابيح أمامية متسخة بشدة."}, a:[
  {de:"Verschmutzte Scheinwerfer reduzieren die Sicht bei Dunkelheit erheblich.", ar:"تُقلّل المصابيح المتسخة الرؤية في الظلام بشكل كبير."},{de:"Regelmässige Reinigung verbessert die Sicherheit.", ar:"التنظيف المنتظم يُحسّن السلامة."},{de:"Die Sauberkeit der Scheinwerfer hat keinen relevanten Einfluss auf die Lichtleistung.", ar:"لنظافة المصابيح لا تأثير يُذكر على أداء الإضاءة."}], correct:[0,1],
  e:{de:"Schmutz kann die Lichtleistung um einen grossen Anteil verringern.", ar:"قد يُقلّل الاتساخ أداء الإضاءة بنسبة كبيرة."}},

// ---------- umwelt (Runde 3) ----------
{ c:"umwelt", q:{de:"Du fährst häufig sehr kurze Strecken mit dem Auto, obwohl ein Velo verfügbar wäre.", ar:"تقود بالسيارة مسافات قصيرة جداً بشكل متكرر رغم توفر دراجة."}, a:[
  {de:"Kurze Autofahrten mit kaltem Motor sind ökologisch besonders ungünstig.", ar:"الرحلات القصيرة بمحرك بارد غير مفيدة بيئياً بشكل خاص."},{de:"Für kurze Strecken sind Velo oder Fussweg oft eine sinnvolle Alternative.", ar:"للمسافات القصيرة، الدراجة أو المشي غالباً بديل منطقي."},{de:"Die Wahl des Verkehrsmittels hat auf kurzen Strecken keinerlei ökologische Bedeutung.", ar:"لاختيار وسيلة النقل لا أهمية بيئية إطلاقاً على المسافات القصيرة."}], correct:[0,1],
  e:{de:"Kurzstrecken machen einen unverhältnismässig grossen Teil der Emissionen im Alltag aus.", ar:"تُشكّل الرحلات القصيرة جزءاً كبيراً بشكل غير متناسب من الانبعاثات اليومية."}},
{ c:"umwelt", q:{de:"Du fährst regelmässig mit einem sehr niedrigen Reifendruck, weil du es bequemer findest.", ar:"تقود بانتظام بضغط إطارات منخفض جداً لأنك تجده أكثر راحة."}, a:[
  {de:"Ein zu tiefer Druck erhöht den Rollwiderstand und damit den Verbrauch.", ar:"الضغط المنخفض جداً يزيد مقاومة التدحرج وبالتالي الاستهلاك."},{de:"Regelmässige Kontrolle des korrekten Drucks lohnt sich ökologisch und finanziell.", ar:"فحص الضغط الصحيح بانتظام مفيد بيئياً ومالياً."},{de:"Der Reifendruck hat auf den Treibstoffverbrauch praktisch keinen Einfluss.", ar:"لضغط الإطارات عملياً لا تأثير على استهلاك الوقود."}], correct:[0,1],
  e:{de:"Der Effekt summiert sich über viele gefahrene Kilometer deutlich.", ar:"يتراكم التأثير بشكل ملحوظ عبر كيلومترات كثيرة مقطوعة."}},
{ c:"umwelt", q:{de:"Du überlegst dir, ob sich eine Fahrt mit dem öffentlichen Verkehr statt dem eigenen Auto lohnt.", ar:"تفكّر إن كانت الرحلة بوسائل النقل العامة أفضل من سيارتك الخاصة."}, a:[
  {de:"Öffentlicher Verkehr kann pro Person deutlich weniger Emissionen verursachen.", ar:"يمكن للنقل العام أن يسبب انبعاثات أقل بكثير لكل شخص."},{de:"Gerade bei vollen Fahrzeugen oder Zügen ist der Effekt grösser.", ar:"يزداد الأثر خاصة مع المركبات أو القطارات المزدحمة."},{de:"Öffentlicher Verkehr hat pro Fahrgast immer einen höheren Verbrauch als ein Auto.", ar:"للنقل العام دائماً استهلاك أعلى لكل راكب من السيارة."}], correct:[0,1],
  e:{de:"Die Auslastung des Verkehrsmittels beeinflusst die Umweltbilanz pro Person stark.", ar:"تؤثر نسبة الإشغال بشكل كبير على الأثر البيئي لكل شخص."}},

// ---------- notfall (Runde 3) ----------
{ c:"notfall", q:{de:"An einer Unfallstelle riechst du deutlich austretenden Treibstoff.", ar:"تشمّ رائحة وقود متسرّب بوضوح في مكان الحادث."}, a:[
  {de:"Offenes Feuer und Rauchen in der Nähe unbedingt vermeiden.", ar:"تجنّب اللهب المكشوف والتدخين قرب المكان تماماً."},{de:"Verletzte, wenn möglich, in sicheren Abstand zur Gefahrenquelle bringen.", ar:"انقل المصابين إن أمكن إلى مسافة آمنة عن مصدر الخطر."},{de:"Austretender Treibstoff stellt in der Regel keine zusätzliche Gefahr dar.", ar:"عادة لا يُشكّل الوقود المتسرّب أي خطر إضافي."}], correct:[0,1],
  e:{de:"Austretender Treibstoff erhöht das Brandrisiko erheblich.", ar:"يزيد الوقود المتسرّب من خطر الحريق بشكل كبير."}},
{ c:"notfall", q:{de:"Eine Person nach einem Unfall klagt über Atemnot, ist aber ansprechbar.", ar:"شخص بعد حادث يشتكي من ضيق تنفس لكنه واعٍ."}, a:[
  {de:"Sofort die Sanität alarmieren.", ar:"اتصل بالإسعاف فوراً."},{de:"Die Person beruhigen und eng anliegende Kleidung wenn möglich lockern.", ar:"طمئن الشخص وحرّر الملابس الضيقة إن أمكن."},{de:"Atemnot nach einem Unfall ist normalerweise kein Grund zur Sorge.", ar:"ضيق التنفس بعد حادث ليس عادة سبباً للقلق."}], correct:[0,1],
  e:{de:"Atemprobleme können auf innere Verletzungen hindeuten und sind ernst zu nehmen.", ar:"قد تُشير مشاكل التنفس إلى إصابات داخلية ويجب أخذها على محمل الجد."}},
{ c:"notfall", q:{de:"Du leistest Erste Hilfe und eine weitere Person am Unfallort bietet spontan ihre Mithilfe an.", ar:"تقدّم إسعافات أولية ويعرض شخص آخر في مكان الحادث المساعدة تلقائياً."}, a:[
  {de:"Aufgaben sinnvoll aufteilen, zum Beispiel Absichern und Alarmieren.", ar:"وزّع المهام بشكل منطقي، مثلاً التأمين والاتصال بالطوارئ."},{de:"Zusätzliche Hilfe kann die Rettungskette beschleunigen.", ar:"يمكن للمساعدة الإضافية أن تُسرّع سلسلة الإنقاذ."},{de:"Weitere Personen sollten grundsätzlich weggeschickt werden, um Chaos zu vermeiden.", ar:"يجب إبعاد الأشخاص الإضافيين أصلاً لتجنّب الفوضى."}], correct:[0,1],
  e:{de:"Koordinierte Zusammenarbeit ist oft wirksamer als eine Einzelperson allein.", ar:"التعاون المنسّق غالباً أكثر فعالية من شخص واحد بمفرده."}},

// ---------- ausweis (Runde 3) ----------
{ c:"ausweis", q:{de:"Du willst dich zur Theorieprüfung anmelden und bist unsicher, welche Unterlagen nötig sind.", ar:"تريد التسجيل للامتحان النظري ولست متأكداً من المستندات المطلوبة."}, a:[
  {de:"Ein gültiger Sehtest gehört in der Regel dazu.", ar:"فحص نظر ساري المفعول من ضمنها عادة."},{de:"Der Nothelferausweis wird ebenfalls verlangt.", ar:"تُطلب أيضاً شهادة الإسعافات الأولية."},{de:"Für die Theorieprüfung selbst sind grundsätzlich keinerlei Unterlagen nötig.", ar:"لا حاجة لأي مستندات أصلاً للامتحان النظري نفسه."}], correct:[0,1],
  e:{de:"Die genauen Anforderungen bestätigt die kantonale Strassenverkehrsbehörde.", ar:"تؤكد مصلحة المركبات الكانتونية المتطلبات الدقيقة."}},
{ c:"ausweis", q:{de:"Du hast die Theorieprüfung bestanden, wartest aber noch auf den Lernfahrausweis.", ar:"اجتزت الامتحان النظري لكنك تنتظر رخصة التعلّم بعد."}, a:[
  {de:"Ohne gültigen Lernfahrausweis darfst du noch kein Fahrzeug alleine führen.", ar:"بلا رخصة تعلّم سارية لا يجوز لك قيادة مركبة بمفردك بعد."},{de:"Die bestandene Theorieprüfung allein berechtigt noch nicht zum Fahren.", ar:"اجتياز النظري وحده لا يُخوّلك القيادة بعد."},{de:"Nach bestandener Theorieprüfung darfst du sofort ohne Begleitung fahren.", ar:"بعد اجتياز النظري يمكنك القيادة فوراً بلا مرافقة."}], correct:[0,1],
  e:{de:"Erst der ausgestellte Lernfahrausweis erlaubt das Fahren mit Begleitperson.", ar:"رخصة التعلّم الصادرة فعلياً هي ما يسمح بالقيادة مع مرافق."}},
{ c:"ausweis", q:{de:"Während der Probezeit möchtest du im Ausland ein Fahrzeug mieten und fahren.", ar:"خلال فترة التجربة تريد استئجار مركبة والقيادة في الخارج."}, a:[
  {de:"Der Schweizer Führerausweis auf Probe kann im Ausland grundsätzlich anerkannt werden.", ar:"يمكن الاعتراف عموماً بالرخصة السويسرية التجريبية في الخارج."},{de:"Örtliche Regeln und Anforderungen des jeweiligen Landes gelten zusätzlich.", ar:"تنطبق إضافياً القواعد والمتطلبات المحلية للبلد المعني."},{de:"Im Ausland gelten während der Probezeit überhaupt keine besonderen Einschränkungen mehr.", ar:"في الخارج لا تنطبق أي قيود خاصة إطلاقاً بعد الآن خلال فترة التجربة."}], correct:[0,1],
  e:{de:"Es lohnt sich, die Anforderungen des Ziellandes vorher zu prüfen.", ar:"يستحق الأمر التحقق من متطلبات بلد الوجهة مسبقاً."}},
{ c:"ausweis", q:{de:"Du hast während der Lernfahrphase mehrere Fahrstunden bei einer Fahrlehrperson und einige mit einer privaten Begleitperson.", ar:"لديك خلال مرحلة التعلّم عدة حصص مع معلّم قيادة وأخرى مع مرافق خاص."}, a:[
  {de:"Beide Formen der Übung sind grundsätzlich zulässig.", ar:"كلا شكلي التدريب مسموحان أصلاً."},{de:"Die Begleitperson muss die gesetzlichen Voraussetzungen erfüllen.", ar:"يجب أن يستوفي المرافق الشروط القانونية."},{de:"Nur eine ausgebildete Fahrlehrperson darf während der ganzen Lernphase je begleiten.", ar:"معلّم القيادة المؤهل فقط يمكنه المرافقة طوال مرحلة التعلّم."}], correct:[0,1],
  e:{de:"Die Kombination aus Fahrschule und privater Übung ist üblich und sinnvoll.", ar:"الجمع بين مدرسة القيادة والتدريب الخاص أمر معتاد ومفيد."}},

// ---------- verkehrsteilnehmer (Runde 3) ----------
{ c:"verkehrsteilnehmer", q:{de:"Ein Fahrzeug mit Anhänger für einen Wohnwagen biegt vor dir sehr langsam ab.", ar:"مركبة تجرّ مقطورة سكنية تنعطف أمامك ببطء شديد."}, a:[
  {de:"Solche Kombinationen brauchen oft mehr Platz und Zeit beim Abbiegen.", ar:"غالباً ما تحتاج هذه التركيبات مساحة ووقتاً أكبر عند الانعطاف."},{de:"Geduldig abwarten und nicht drängeln.", ar:"انتظر بصبر ولا تستعجل."},{de:"Ein Anhänger darf im Verkehr grundsätzlich niemals langsamer abbiegen als ein einzelnes Auto.", ar:"لا يجوز أبداً للمقطورة الانعطاف أبطأ من سيارة منفردة أصلاً."}], correct:[0,1],
  e:{de:"Ungeduld gegenüber grösseren Fahrzeugkombinationen führt leicht zu gefährlichen Situationen.", ar:"نفاد الصبر تجاه التركيبات الكبيرة يؤدي بسهولة إلى مواقف خطيرة."}},
{ c:"verkehrsteilnehmer", q:{de:"Auf dem Trottoir neben der Fahrbahn spielt ein Kind mit einem Ball nahe der Strasse.", ar:"طفل يلعب بكرة قرب الطريق على الرصيف المجاور."}, a:[
  {de:"Kinder können sich plötzlich und unerwartet in Richtung Fahrbahn bewegen.", ar:"قد يتحرك الأطفال فجأة وبشكل غير متوقع نحو الطريق."},{de:"Tempo reduzieren und besonders aufmerksam sein.", ar:"خفّض السرعة وكن منتبهاً بشكل خاص."},{de:"Solange das Kind auf dem Trottoir bleibt, besteht überhaupt kein Risiko.", ar:"طالما بقي الطفل على الرصيف لا يوجد أي خطر إطلاقاً."}], correct:[0,1],
  e:{de:"Der Ball selbst oder die Konzentration aufs Spiel kann das Kind schnell auf die Strasse führen.", ar:"قد تقود الكرة نفسها أو التركيز على اللعب الطفل بسرعة إلى الطريق."}},
{ c:"verkehrsteilnehmer", q:{de:"Ein Fahrzeug mit Fahrschulschild und zwei Personen im Auto verhält sich an einer Kreuzung zögerlich.", ar:"مركبة عليها لوحة مدرسة قيادة وبها شخصان تتصرف بتردد عند تقاطع."}, a:[
  {de:"Das deutet auf eine Fahrstunde mit Lernfahrer hin.", ar:"يُشير ذلك إلى حصة قيادة مع متدرب."},{de:"Zusätzliche Geduld ist hier besonders angebracht.", ar:"الصبر الإضافي مناسب هنا بشكل خاص."},{de:"Fahrschulfahrzeuge haben rechtlich exakt dieselben Reaktionszeiten wie erfahrene Fahrer.", ar:"لمركبات مدرسة القيادة قانونياً نفس أزمنة رد الفعل تماماً كالسائقين ذوي الخبرة."}], correct:[0,1],
  e:{de:"Lernende reagieren oft langsamer und brauchen mehr Zeit für Entscheidungen.", ar:"غالباً ما يتفاعل المتدربون ببطء أكبر ويحتاجون وقتاً أطول لاتخاذ القرار."}},

// ---------- bahnuebergang (Runde 3) ----------
{ c:"bahnuebergang", q:{de:"Ein Bahnübergang für eine touristische Schmalspurbahn hat kein akustisches Signal, nur ein Blinklicht.", ar:"معبر سكة لقطار سياحي ضيق المسار بلا صافرة، بضوء وامض فقط."}, a:[
  {de:"Auch ohne Ton bleibt das Blinklicht verbindlich.", ar:"يبقى الضوء الوامض ملزماً حتى بلا صوت."},{de:"Bei Aufleuchten oder Blinken des roten Lichts anhalten.", ar:"توقّف عند إضاءة أو وميض الضوء الأحمر."},{de:"Touristische Bahnen haben grundsätzlich weniger Vortrittsrecht als reguläre Züge.", ar:"لقطارات سياحية أولوية أقل أصلاً من القطارات العادية."}], correct:[0,1],
  e:{de:"Die Art der Bahn ändert nichts an der Verbindlichkeit der Signalanlage.", ar:"نوع القطار لا يغيّر شيئاً من إلزامية جهاز الإشارة."}},
{ c:"bahnuebergang", q:{de:"Kurz nachdem eine Schranke sich öffnet, hörst du bereits wieder das Warnsignal für den nächsten Zug.", ar:"بعد فتح الحاجز بقليل تسمع تحذير القطار التالي مجدداً."}, a:[
  {de:"Zügig, aber sicher über die Gleise fahren.", ar:"اعبر القضبان بسرعة معقولة وبأمان."},{de:"Nicht auf den Gleisen stehen bleiben oder zögern.", ar:"لا تتوقف على القضبان ولا تتردد."},{de:"Ein erneutes Signal kurz nach dem Öffnen kann ignoriert werden.", ar:"يمكن تجاهل إشارة جديدة بعد الفتح بقليل."}], correct:[0,1],
  e:{de:"Bei dichtem Zugverkehr kann sich die Schranke sehr bald wieder schliessen.", ar:"عند ازدحام حركة القطارات قد ينغلق الحاجز مجدداً بسرعة."}},

// ---------- parken_halten (Runde 3) ----------
{ c:"parken_halten", q:{de:"Du willst kurz an einem Fussgängerstreifen halten, um jemanden aussteigen zu lassen.", ar:"تريد التوقف لحظة عند ممر مشاة لإنزال أحد الركاب."}, a:[
  {de:"Halten auf dem Fussgängerstreifen ist verboten.", ar:"الوقوف على ممر المشاة ممنوع."},{de:"Eine geeignete Stelle kurz davor oder danach suchen.", ar:"ابحث عن مكان مناسب قبله أو بعده."},{de:"Kurzes Aussteigenlassen ist auf dem Streifen ausdrücklich erlaubt.", ar:"إنزال الركاب لفترة قصيرة على الممر مسموح صراحة."}], correct:[0,1],
  e:{de:"Der Streifen muss für Fussgänger immer vollständig frei bleiben.", ar:"يجب أن يبقى الممر خالياً تماماً للمشاة دائماً."}},
{ c:"parken_halten", q:{de:"Auf einem grossen Parkplatz willst du quer über mehrere markierte Felder parkieren, um mehr Platz zu haben.", ar:"في موقف كبير تريد الركن عرضياً عبر عدة مواقع معلَّمة لتحصل على مساحة أكبر."}, a:[
  {de:"Das blockiert unnötig zusätzliche Parkplätze für andere.", ar:"يسدّ ذلك بلا داعٍ مواقف إضافية للآخرين."},{de:"Innerhalb der markierten Fläche parkieren ist die korrekte Vorgehensweise.", ar:"الركن ضمن المساحة المعلَّمة هو التصرف الصحيح."},{de:"Bei wenig Verkehr im Parkhaus ist ein Parkieren über mehrere Felder unproblematisch.", ar:"عند قلة الحركة في المرآب، الركن عبر عدة مواقع غير مشكلة."}], correct:[0,1],
  e:{de:"Rücksicht auf andere gilt auch auf Parkplätzen.", ar:"مراعاة الآخرين سارية أيضاً في المواقف."}},

// ---------- ladung_transport (Runde 3) ----------
{ c:"ladung_transport", q:{de:"Du transportierst mehrere lose Getränkeflaschen im Fussraum des Beifahrersitzes.", ar:"تنقل عدة زجاجات مشروبات غير مثبتة في مساحة القدمين بجانب المقعد الأمامي."}, a:[
  {de:"Lose Flaschen können bei einer Bremsung unter die Pedale rollen.", ar:"قد تتدحرج الزجاجات غير المثبتة تحت الدواسات عند الكبح."},{de:"Das kann die Bedienung des Fahrzeugs gefährlich behindern.", ar:"قد يعيق ذلك التحكم بالمركبة بشكل خطير."},{de:"Gegenstände im Fussraum haben keinerlei Einfluss auf die Fahrsicherheit.", ar:"للأغراض في مساحة القدمين لا تأثير إطلاقاً على سلامة القيادة."}], correct:[0,1],
  e:{de:"Besonders die Bremspedal-Zone muss immer frei bleiben.", ar:"يجب أن تبقى منطقة دواسة الكبح خالية دائماً بشكل خاص."}},
{ c:"ladung_transport", q:{de:"Du transportierst einen grossen Gegenstand, der die Rundumsicht stark einschränkt.", ar:"تنقل غرضاً كبيراً يُقيّد الرؤية المحيطة بشدة."}, a:[
  {de:"Die Sicht nach hinten und zur Seite darf nicht wesentlich beeinträchtigt werden.", ar:"يجب ألا تتأثر الرؤية إلى الخلف والجانبين بشكل جوهري."},{de:"Wenn nötig, eine zusätzliche Person zum Einweisen hinzuziehen.", ar:"استعن بشخص إضافي للتوجيه عند الحاجة."},{de:"Solange die Frontscheibe frei ist, spielt die restliche Sicht keine Rolle.", ar:"طالما الزجاج الأمامي خالٍ، لا أهمية لباقي الرؤية."}], correct:[0,1],
  e:{de:"Toter Winkel und Rückspiegel-Sicht sind für sicheres Manövrieren essenziell.", ar:"النقطة العمياء ورؤية المرآة الخلفية أساسيتان للمناورة الآمنة."}},

,

// ---------- grundregeln (Runde 4) ----------
{ c:"grundregeln", q:{de:"Du fährst durch eine Fussgängerzone, in der Anlieferverkehr zu bestimmten Zeiten erlaubt ist.", ar:"تمرّ عبر منطقة مشاة يُسمح فيها بتوريد البضائع في أوقات معينة."}, a:[
  {de:"Schrittgeschwindigkeit ist dort angebracht.", ar:"سرعة المشي مناسبة هناك."},{de:"Fussgänger haben klaren Vorrang vor dem Fahrzeug.", ar:"للمشاة أولوية واضحة على المركبة."},{de:"Mit erlaubter Zufahrt darfst du normal zügig durchfahren.", ar:"مع إذن الدخول يمكنك المرور بسرعة عادية."}], correct:[0,1],
  e:{de:"Die Erlaubnis zur Zufahrt hebt den Fussgängervorrang nicht auf.", ar:"إذن الدخول لا يُلغي أولوية المشاة."}},
{ c:"grundregeln", q:{de:"Du transportierst eine weitere erwachsene Person, die zum ersten Mal in deinem Auto mitfährt.", ar:"تنقل شخصاً بالغاً آخر يركب سيارتك لأول مرة."}, a:[
  {de:"Ein kurzer Hinweis auf Gurt und Verhalten kann sinnvoll sein.", ar:"تذكير سريع بالحزام والسلوك قد يكون مفيداً."},{de:"Die Verantwortung für die eigene Sicherheit tragen erwachsene Mitfahrende grundsätzlich mit.", ar:"يتحمّل الركاب البالغون أصلاً جزءاً من مسؤولية سلامتهم."},{de:"Als Fahrzeugführer musst du für jede Handlung der Mitfahrenden haften.", ar:"بصفتك السائق، عليك تحمل مسؤولية كل تصرف للركاب."}], correct:[0,1],
  e:{de:"Klare Kommunikation vor der Fahrt schafft Sicherheit für alle.", ar:"التواصل الواضح قبل الانطلاق يخلق أماناً للجميع."}},
{ c:"grundregeln", q:{de:"Auf einer wenig befahrenen Nebenstrasse hältst du dich strikt an alle Regeln, wirkst dabei aber unsicher und zögerlich.", ar:"على طريق فرعي قليل الاستخدام تلتزم بصرامة بكل القواعد لكنك تبدو متردداً وغير واثق."}, a:[
  {de:"Andere könnten dein Verhalten falsch einschätzen.", ar:"قد يُخطئ آخرون في تقدير تصرفك."},{de:"Klares, vorhersehbares Verhalten ist für andere Verkehrsteilnehmer wichtig.", ar:"التصرف الواضح والمتوقع مهم لمستخدمي الطريق الآخرين."},{de:"Zögerliches Verhalten hat keinerlei Einfluss auf andere Fahrzeuge.", ar:"للتصرف المتردد لا تأثير إطلاقاً على المركبات الأخرى."}], correct:[0,1],
  e:{de:"Unvorhersehbares Verhalten kann selbst bei korrekten Regeln zu Missverständnissen führen.", ar:"قد يؤدي التصرف غير المتوقع إلى سوء فهم حتى مع الالتزام الصحيح بالقواعد."}},
{ c:"grundregeln", q:{de:"Du fährst mit heruntergelassenen Fenstern durch ein Wohnquartier spät in der Nacht.", ar:"تسير بنوافذ مفتوحة عبر حي سكني في وقت متأخر من الليل."}, a:[
  {de:"Motorengeräusch und Musik können Anwohner belästigen.", ar:"قد يُزعج صوت المحرك والموسيقى السكان."},{de:"Die Grundregel verbietet unnötige Belästigung anderer.", ar:"القاعدة الأساسية تمنع الإزعاج غير الضروري للآخرين."},{de:"Nachts gelten für Lärm auf öffentlichen Strassen überhaupt keine Rücksichtspflichten.", ar:"لا توجد أي واجبات مراعاة بخصوص الضجيج على الطرق العامة ليلاً إطلاقاً."}], correct:[0,1],
  e:{de:"«Belästigen» in der Grundregel schliesst auch unnötigen Lärm ein.", ar:"«الإزعاج» في القاعدة الأساسية يشمل أيضاً الضجيج غير الضروري."}},
{ c:"grundregeln", q:{de:"Ein Hund sitzt unangeleint frei im Fahrzeug und bewegt sich während der Fahrt zwischen den Sitzen.", ar:"كلب بلا مقود يجلس بحرية في المركبة ويتحرك بين المقاعد أثناء القيادة."}, a:[
  {de:"Ein frei bewegliches Tier kann den Fahrer ablenken oder behindern.", ar:"قد يشتت الحيوان الذي يتحرك بحرية السائق أو يعيقه."},{de:"Eine geeignete Sicherung reduziert dieses Risiko.", ar:"التثبيت المناسب يُقلّل هذا الخطر."},{de:"Tiere im Fahrzeug haben grundsätzlich keinerlei Einfluss auf die Fahrsicherheit.", ar:"للحيوانات في المركبة لا تأثير إطلاقاً على سلامة القيادة."}], correct:[0,1],
  e:{de:"Die Grundregel verlangt, dass der Fahrer stets Herr über sein Fahrzeug bleibt.", ar:"تتطلب القاعدة الأساسية أن يبقى السائق متحكماً بمركبته دائماً."}},
{ c:"grundregeln", q:{de:"Du fährst zum ersten Mal auf der linken Fahrzeugseite in einem Land mit Linksverkehr (nicht die Schweiz).", ar:"تقود لأول مرة من الجانب الأيسر في بلد يسير فيه على اليسار (ليست سويسرا)."}, a:[
  {de:"Ungewohnte Verkehrsverhältnisse erhöhen das Fehlerrisiko.", ar:"تزيد ظروف السير غير المألوفة من خطر الخطأ."},{de:"Besondere Konzentration und Vorsicht sind angebracht.", ar:"التركيز والحذر الإضافيان مناسبان."},{de:"Fahrpraxis aus der Schweiz lässt sich immer eins zu eins ohne Anpassung übertragen.", ar:"يمكن دائماً نقل خبرة القيادة السويسرية مباشرة بلا أي تكيّف."}], correct:[0,1],
  e:{de:"Automatisierte Reflexe aus dem Rechtsverkehr können im Linksverkehr zu Fehlern führen.", ar:"قد تؤدي الانعكاسات التلقائية من السير على اليمين إلى أخطاء في السير على اليسار."}},
{ c:"grundregeln", q:{de:"Du bemerkst, dass dein Fahrzeug beim Start ungewöhnlich reagiert, kannst die Ursache aber nicht sofort erkennen.", ar:"تلاحظ أن مركبتك تتصرف بشكل غير معتاد عند الانطلاق لكن لا يمكنك تحديد السبب فوراً."}, a:[
  {de:"Im Zweifel vorsichtiger fahren oder das Fahrzeug prüfen lassen.", ar:"قُد بحذر أكبر عند الشك أو اطلب فحص المركبة."},{de:"Ungewöhnliches Verhalten des Fahrzeugs ernst nehmen.", ar:"خذ التصرف غير المعتاد للمركبة على محمل الجد."},{de:"Solange das Fahrzeug fährt, kannst du jedes ungewöhnliche Zeichen ignorieren.", ar:"طالما المركبة تسير، يمكنك تجاهل أي علامة غير معتادة."}], correct:[0,1],
  e:{de:"Frühzeitiges Erkennen von Problemen verhindert grössere Gefahren.", ar:"الاكتشاف المبكر للمشاكل يمنع أخطاراً أكبر."}},
{ c:"grundregeln", q:{de:"Du hast gerade erst den Führerausweis erhalten und fühlst dich in dichtem Stadtverkehr noch unsicher.", ar:"حصلت للتو على رخصتك ولا تزال غير واثق في سير المدينة المزدحم."}, a:[
  {de:"Zusätzliche Vorsicht und etwas mehr Zeit einplanen ist sinnvoll.", ar:"الحذر الإضافي وتخصيص وقت أطول أمر منطقي."},{de:"Unsicherheit mit der Zeit und Übung ist normal.", ar:"التردد مع الوقت والممارسة أمر طبيعي."},{de:"Nach bestandener Prüfung solltest du dich in jeder Situation sofort genauso sicher fühlen wie erfahrene Fahrer.", ar:"بعد اجتياز الامتحان يجب أن تشعر فوراً بنفس ثقة السائقين ذوي الخبرة في كل موقف."}], correct:[0,1],
  e:{de:"Fahrerfahrung entwickelt sich erst über die Zeit, das ist völlig normal.", ar:"تتطور خبرة القيادة مع الوقت فقط، وهذا أمر طبيعي تماماً."}},

// ---------- signale (Runde 4) ----------
{ c:"signale", q:{de:"An einer Kreuzung ist die Ampel ausser Betrieb, ein Signal für Rechtsvortritt steht daneben nicht.", ar:"عند تقاطع، الإشارة الضوئية خارج الخدمة، ولا توجد إشارة أولوية يمين بجانبها."}, a:[
  {de:"Ohne funktionierende Ampel gilt automatisch der Rechtsvortritt.", ar:"بلا إشارة تعمل، تسري أولوية اليمين تلقائياً."},{de:"Besonders vorsichtig herantasten, da andere die Regel eventuell nicht kennen.", ar:"اقترب بحذر خاص لأن آخرين قد لا يعرفون القاعدة."},{de:"Eine ausser Betrieb gesetzte Ampel bedeutet automatisch, dass niemand Vortritt hat.", ar:"إشارة معطّلة تعني تلقائياً أنه لا أحد له الأولوية."}], correct:[0,1],
  e:{de:"Der Rechtsvortritt ist die Grundregel, sobald keine gültige Signalisation mehr aktiv ist.", ar:"أولوية اليمين هي القاعدة الأساسية بمجرد عدم وجود إشارة سارية فعّالة."}},
{ c:"signale", q:{de:"Auf einer Autostrasse siehst du ein blaues rechteckiges Signal mit einem Autosymbol.", ar:"على طريق سيار ترى إشارة زرقاء مستطيلة برمز سيارة."}, a:[
  {de:"Das kennzeichnet den Beginn einer Autostrasse.", ar:"تُشير إلى بداية طريق سيار."},{de:"Bestimmte langsame Fahrzeuge und Fussgänger sind dort nicht zugelassen.", ar:"لا يُسمح هناك بمركبات بطيئة معينة ولا للمشاة."},{de:"Auf einer Autostrasse gilt automatisch dieselbe Höchstgeschwindigkeit wie auf der Autobahn.", ar:"على الطريق السيار تسري تلقائياً نفس السرعة القصوى للأوتوستراد."}], correct:[0,1],
  e:{de:"Autostrassen erlauben 100 km/h, Autobahnen 120 km/h.", ar:"الطريق السيار يسمح بـ100 كم/س، والأوتوستراد بـ120 كم/س."}},
{ c:"signale", q:{de:"Eine Baustelle verdeckt teilweise ein bestehendes Vortrittssignal.", ar:"أشغال طريق تُغطّي جزئياً إشارة أولوية موجودة."}, a:[
  {de:"Bei eingeschränkter Erkennbarkeit besonders vorsichtig fahren.", ar:"قُد بحذر خاص عند صعوبة رؤية الإشارة."},{de:"Wenn möglich, auf zusätzliche provisorische Signalisation achten.", ar:"انتبه إن أمكن لإشارات مؤقتة إضافية."},{de:"Ein teilweise verdecktes Signal darf als vollständig ungültig behandelt werden.", ar:"يمكن اعتبار الإشارة المُغطّاة جزئياً باطلة تماماً."}], correct:[0,1],
  e:{de:"Baustellen verändern oft kurzfristig die normale Signalisation.", ar:"غالباً ما تُغيّر الأشغال الإشارات المعتادة بشكل مؤقت."}},
{ c:"signale", q:{de:"Ein Signal zeigt eine Höchstgeschwindigkeit nur für Lastwagen, PKW sind nicht erwähnt.", ar:"إشارة تُظهر حداً أقصى للسرعة للشاحنات فقط، دون ذكر السيارات."}, a:[
  {de:"Solche Signale können fahrzeugspezifisch gelten.", ar:"يمكن أن تنطبق هذه الإشارات على نوع مركبة معين."},{de:"Für PKW gilt dann meist das allgemeine Limit der Strasse.", ar:"يسري على السيارات عادة الحد العام للطريق."},{de:"Ein fahrzeugspezifisches Signal gilt automatisch für alle Fahrzeugtypen gleichermassen.", ar:"تنطبق الإشارة المخصصة لنوع مركبة تلقائياً على جميع الأنواع بالتساوي."}], correct:[0,1],
  e:{de:"Zusatztafeln unter dem Signal geben oft an, für welche Fahrzeuge es gilt.", ar:"غالباً ما تُحدد اللوحات الإضافية تحت الإشارة المركبات المعنية بها."}},
{ c:"signale", q:{de:"Du siehst eine Bodenmarkierung mit einem aufgemalten Velo-Piktogramm mitten auf einer normalen Fahrspur.", ar:"ترى علامة أرضية برسم دراجة في منتصف مسرب سير عادي."}, a:[
  {de:"Das weist auf gemischten Verkehr mit Velofahrern auf dieser Spur hin.", ar:"تُشير إلى سير مختلط مع دراجات على هذا المسرب."},{de:"Autofahrer sollten mit Velofahrern auf der Spur rechnen und Abstand halten.", ar:"على السائقين توقّع دراجات على المسرب والحفاظ على مسافة."},{de:"Ein solches Piktogramm bedeutet ein Fahrverbot für Motorfahrzeuge.", ar:"يعني هذا الرسم منع دخول المركبات الآلية."}], correct:[0,1],
  e:{de:"Diese Markierung erinnert Autofahrer daran, dass die Spur geteilt wird.", ar:"تُذكّر هذه العلامة السائقين بأن المسرب مشترك."}},
{ c:"signale", q:{de:"Ein oranges, rautenförmiges Signal an einem Fahrzeug weist auf gefährliche Ladung hin.", ar:"إشارة برتقالية معينية الشكل على مركبة تُشير إلى حمولة خطرة."}, a:[
  {de:"Grösseren Sicherheitsabstand zu einem solchen Fahrzeug halten.", ar:"حافظ على مسافة أمان أكبر عن مركبة كهذه."},{de:"Bei einem Unfall mit diesem Fahrzeug besondere Vorsicht walten lassen.", ar:"توخَّ حذراً خاصاً عند حادث مع مركبة كهذه."},{de:"Solche Kennzeichnungen sind rein informativ und ohne jede praktische Bedeutung für andere.", ar:"هذه العلامات إعلامية بحتة وبلا أي أهمية عملية للآخرين."}], correct:[0,1],
  e:{de:"Gefahrguttransporte erfordern von allen Beteiligten erhöhte Vorsicht.", ar:"تتطلب نقلات المواد الخطرة حذراً متزايداً من جميع الأطراف."}},
{ c:"signale", q:{de:"An einer Kreuzung mit Lichtsignal blinkt zusätzlich ein Signal für Fussgänger.", ar:"عند تقاطع بإشارة ضوئية، يومض ضوء إضافي خاص بالمشاة."}, a:[
  {de:"Fussgänger-Signale regeln eigenständig, wann Fussgänger queren dürfen.", ar:"تنظّم إشارات المشاة بشكل مستقل متى يمكنهم العبور."},{de:"Als Fahrzeugführer musst du trotzdem grundsätzlich auf Fussgänger achten.", ar:"عليك رغم ذلك الانتباه للمشاة أساساً بصفتك سائقاً."},{de:"Fussgänger-Signale haben für den Fahrzeugverkehr keinerlei Bedeutung.", ar:"إشارات المشاة ليس لها أي أهمية إطلاقاً بالنسبة لحركة المركبات."}], correct:[0,1],
  e:{de:"Grün für Fussgänger bedeutet oft gleichzeitig eine Vortrittspflicht für abbiegende Fahrzeuge.", ar:"الأخضر للمشاة غالباً ما يعني في الوقت نفسه واجب منح الأولوية من المركبات المنعطفة."}},
{ c:"signale", q:{de:"Du siehst auf der Fahrbahn eine breite weisse Haltelinie ohne zugehöriges Signal.", ar:"ترى على الطريق خطاً أبيض عريضاً للتوقف بلا إشارة مرافقة."}, a:[
  {de:"Sie markiert die Stelle, an der du bei Bedarf anhalten musst.", ar:"يُحدد المكان الذي يجب أن تتوقف عنده عند الحاجة."},{de:"Sie gehört meist zu einer Ampel oder einem Stoppsignal in der Nähe.", ar:"ينتمي عادة إلى إشارة مرور أو إشارة قف قريبة."},{de:"Eine Haltelinie ohne sichtbares Signal darf grundsätzlich ignoriert werden.", ar:"يمكن تجاهل خط التوقف بلا إشارة ظاهرة أصلاً."}], correct:[0,1],
  e:{de:"Haltelinien präzisieren, wo genau angehalten werden muss.", ar:"تُحدد خطوط التوقف بدقة أين يجب التوقف بالضبط."}},
{ c:"signale", q:{de:"Ein Signal mit einem durchgestrichenen Fussgänger-Symbol steht am Rand einer Autostrasse.", ar:"إشارة برمز مشاة مشطوب موجودة على حافة طريق سيار."}, a:[
  {de:"Fussgänger dürfen diese Strasse nicht betreten.", ar:"لا يجوز للمشاة دخول هذا الطريق."},{de:"Solche Signale schützen sowohl Fussgänger als auch den fliessenden Verkehr.", ar:"تحمي هذه الإشارات المشاة والسير المتدفق معاً."},{de:"Das Verbot gilt nur für Kinder, Erwachsene dürfen die Strasse trotzdem betreten.", ar:"المنع يخص الأطفال فقط، ويمكن للبالغين دخول الطريق رغم ذلك."}], correct:[0,1],
  e:{de:"Auf Autostrassen ist der Fussgängerverkehr aus Sicherheitsgründen generell ausgeschlossen.", ar:"يُستبعد سير المشاة عموماً على الطرق السيارة لأسباب أمنية."}},
{ c:"signale", q:{de:"An einem Fussgängerstreifen mit eigener Ampel zeigt diese für dich Grün, gleichzeitig überquert noch eine Person den Streifen.", ar:"عند ممر مشاة بإشارة خاصة، الضوء أخضر بالنسبة لك بينما لا يزال شخص يعبر الممر."}, a:[
  {de:"Trotz Grün für dich muss die Person den Streifen sicher verlassen können.", ar:"رغم الأخضر لك، يجب أن يتمكن الشخص من مغادرة الممر بأمان."},{de:"Warten, bis der Streifen wirklich frei ist.", ar:"انتظر حتى يخلو الممر فعلاً."},{de:"Grün für dich bedeutet, dass du ungeachtet der Person sofort losfahren darfst.", ar:"الأخضر لك يعني أن بإمكانك الانطلاق فوراً بصرف النظر عن الشخص."}], correct:[0,1],
  e:{de:"Die Ampel schützt Fussgänger meist mit einer Verzögerung für den Fahrzeugverkehr.", ar:"تحمي الإشارة المشاة عادة بتأخير مخصص لحركة المركبات."}},

// ---------- tempo (Runde 4) ----------
{ c:"tempo", q:{de:"Du fährst mit einem Neuwagen, der dir subjektiv sehr ruhig und leise bei hohem Tempo vorkommt.", ar:"تقود سيارة جديدة تبدو لك هادئة جداً وناعمة عند سرعة عالية."}, a:[
  {de:"Ein ruhiges Fahrgefühl täuscht leicht über die tatsächliche Geschwindigkeit hinweg.", ar:"الشعور الهادئ بالقيادة قد يُضلّل بسهولة بشأن السرعة الفعلية."},{de:"Regelmässiger Blick auf den Tacho bleibt wichtig.", ar:"تبقى النظرة المنتظمة إلى العداد مهمة."},{de:"Ein leises Fahrgefühl bedeutet automatisch eine niedrigere tatsächliche Geschwindigkeit.", ar:"الشعور الهادئ بالقيادة يعني تلقائياً سرعة فعلية أقل."}], correct:[0,1],
  e:{de:"Moderne, gut gedämmte Fahrzeuge lassen hohe Geschwindigkeiten oft langsamer wirken.", ar:"غالباً ما تجعل المركبات الحديثة جيدة العزل السرعة العالية تبدو أبطأ."}},
{ c:"tempo", q:{de:"Du fährst mit knapp genügendem Abstand hinter einem Motorradfahrer.", ar:"تسير بمسافة كافية بالكاد خلف دراجة نارية."}, a:[
  {de:"Motorräder können abrupter abbremsen als grössere Fahrzeuge wirken lassen.", ar:"قد تكبح الدراجات النارية بشكل أكثر مفاجأة مما توحي به المركبات الأكبر."},{de:"Ein grosszügigerer Abstand ist hier besonders sinnvoll.", ar:"مسافة أكبر سخاء منطقية هنا بشكل خاص."},{de:"Der nötige Abstand zu Motorrädern ist grundsätzlich kleiner als zu Autos.", ar:"المسافة اللازمة عن الدراجات النارية أصلاً أصغر منها عن السيارات."}], correct:[0,1],
  e:{de:"Die geringere Grösse eines Motorrads verzerrt oft die Abstandswahrnehmung.", ar:"غالباً ما يُشوّه صغر حجم الدراجة النارية إدراك المسافة."}},
{ c:"tempo", q:{de:"Du überquerst eine Brücke, auf der es deutlich kälter zu sein scheint als auf der übrigen Strecke.", ar:"تعبر جسراً يبدو أكثر برودة بوضوح من باقي الطريق."}, a:[
  {de:"Brücken frieren wegen der Kälte von allen Seiten oft früher als normale Strassen.", ar:"غالباً ما تتجمّد الجسور قبل الطرق العادية بسبب البرودة من كل الجهات."},{de:"Bei Frostgefahr Tempo vorsorglich reduzieren.", ar:"خفّض السرعة احترازياً عند خطر التجمد."},{de:"Brücken verhalten sich bei Kälte immer identisch wie die umliegende Strasse.", ar:"تتصرف الجسور دائماً بشكل مطابق تماماً للطريق المحيط عند البرودة."}], correct:[0,1],
  e:{de:"Deshalb wird auf vielen Brücken vor Glatteisgefahr gewarnt.", ar:"لهذا يُحذَّر من خطر الجليد على كثير من الجسور."}},
{ c:"tempo", q:{de:"Auf einer Bergstrasse mit vielen engen Kurven ist eine allgemeine Höchstgeschwindigkeit von 80 km/h signalisiert.", ar:"على طريق جبلي بمنعطفات ضيقة كثيرة، السرعة القصوى المُشار إليها 80 كم/س."}, a:[
  {de:"In den Kurven selbst ist meist eine deutlich tiefere Geschwindigkeit nötig.", ar:"يلزم في المنعطفات نفسها سرعة أقل بكثير عادة."},{de:"Die Geschwindigkeit muss dem tatsächlichen Kurvenverlauf angepasst werden.", ar:"يجب تكييف السرعة مع مسار المنعطف الفعلي."},{de:"Solange das Signal 80 km/h erlaubt, ist diese Geschwindigkeit auch in jeder Kurve sicher.", ar:"طالما الإشارة تسمح بـ80 كم/س، فهذه السرعة آمنة في كل منعطف أيضاً."}], correct:[0,1],
  e:{de:"Das Signal ist eine Obergrenze für die ganze Strecke, nicht eine Empfehlung für jede einzelne Kurve.", ar:"الإشارة حد أقصى لكامل المقطع، لا توصية لكل منعطف على حدة."}},
{ c:"tempo", q:{de:"Du fährst mit einem vollbesetzten Auto und viel Gepäck eine lange Bergabfahrt hinunter.", ar:"تقود سيارة ممتلئة بالركاب والأمتعة في نزول جبلي طويل."}, a:[
  {de:"Höheres Gewicht kann den Bremsweg verlängern.", ar:"قد يُطيل الوزن الأكبر مسافة الكبح."},{de:"Einen niedrigeren Gang nutzen, um die Bremsen zu entlasten.", ar:"استخدم غياراً منخفضاً لتخفيف الحمل عن الفرامل."},{de:"Das Gesamtgewicht des Fahrzeugs hat bei Bergabfahrten keinen relevanten Einfluss.", ar:"للوزن الإجمالي للمركبة لا تأثير يُذكر في المنحدرات."}], correct:[0,1],
  e:{de:"Dauerbremsen bei langen Gefällstrecken kann zu Überhitzung der Bremsen führen.", ar:"الكبح المستمر في المنحدرات الطويلة قد يؤدي إلى ارتفاع حرارة الفرامل."}},

// ---------- vortritt (Runde 4) ----------
{ c:"vortritt", q:{de:"An einer Kreuzung mit Rechtsvortritt kommt ein Fahrzeug von rechts aus einer sehr schmalen Gasse.", ar:"عند تقاطع بأولوية اليمين تأتي مركبة من اليمين من زقاق ضيّق جداً."}, a:[
  {de:"Solange keine anderslautende Signalisation besteht, gilt weiterhin Rechtsvortritt.", ar:"طالما لا توجد إشارة تنص على خلاف ذلك، تبقى أولوية اليمين سارية."},{de:"Die Breite der Gasse allein ändert nichts an der Vortrittsregel.", ar:"عرض الزقاق وحده لا يغيّر شيئاً من قاعدة الأولوية."},{de:"Aus einer sehr schmalen Gasse besteht grundsätzlich nie Vortritt.", ar:"من زقاق ضيّق جداً لا توجد أولوية أصلاً أبداً."}], correct:[0,1],
  e:{de:"Nur ein Signal wie «Kein Vortritt» kann diese Regel für die Gasse aufheben.", ar:"إشارة مثل «لا أولوية» فقط يمكنها إلغاء هذه القاعدة بالنسبة للزقاق."}},
{ c:"vortritt", q:{de:"Du willst als Fussgänger auf einem Fussgängerstreifen eine Strasse überqueren, ein Auto blinkt zum Abbiegen in diese Strasse.", ar:"كمشاة تريد عبور طريق عند ممر مشاة، وسيارة تشغّل الغماز للانعطاف إلى هذا الطريق."}, a:[
  {de:"Ein abbiegendes Fahrzeug muss dir als querendem Fussgänger den Vortritt lassen.", ar:"يجب على المركبة المنعطفة منحك الأولوية بصفتك مشاة عابراً."},{de:"Der Blinker allein gibt dem Fahrzeug keinen Vortritt vor dir.", ar:"الغماز وحده لا يمنح المركبة الأولوية عليك."},{de:"Beim Abbiegen dürfen Fahrzeuge grundsätzlich vor querenden Fussgängern fahren.", ar:"يمكن للمركبات المنعطفة أصلاً المرور قبل المشاة العابرين."}], correct:[0,1],
  e:{de:"Abbiegender Verkehr muss Fussgänger auf dem Streifen immer durchlassen.", ar:"يجب على السير المنعطف السماح دائماً للمشاة على الممر بالعبور."}},
{ c:"vortritt", q:{de:"An einer komplexen Kreuzung mit mehreren Signalen bist du dir kurz nicht sicher, wer Vortritt hat.", ar:"عند تقاطع معقّد بعدة إشارات، لست متأكداً للحظة من له الأولوية."}, a:[
  {de:"Im Zweifel eher bremsbereit und langsamer fahren.", ar:"عند الشك كن مستعداً للكبح وسِر أبطأ."},{de:"Blickkontakt mit anderen Verkehrsteilnehmern kann helfen.", ar:"التواصل بالنظر مع مستخدمي الطريق الآخرين قد يساعد."},{de:"Bei Unsicherheit darfst du automatisch von eigenem Vortritt ausgehen.", ar:"عند عدم اليقين يمكنك افتراض أن لك الأولوية تلقائياً."}], correct:[0,1],
  e:{de:"Vorsicht bei Unklarheit verhindert die meisten Kreuzungsunfälle.", ar:"الحذر عند الغموض يمنع معظم حوادث التقاطعات."}},
{ c:"vortritt", q:{de:"Ein Fahrzeug fährt aus einer Bushaltestellenbucht wieder in den fliessenden Verkehr ein, es ist kein regulärer Linienbus.", ar:"مركبة تخرج من جيب موقف حافلات إلى السير المتدفق، وهي ليست حافلة خط منتظمة."}, a:[
  {de:"Ohne die Sonderregel für Busse hat dieses Fahrzeug beim Einfahren keinen automatischen Vortritt.", ar:"بلا القاعدة الخاصة بالحافلات، ليس لهذه المركبة أولوية تلقائية عند الدخول."},{de:"Es muss sich wie beim Ausparken in den Verkehr einordnen.", ar:"عليها الاندماج في السير كما عند الخروج من موقف."},{de:"Jedes Fahrzeug, das aus einer Haltebucht kommt, hat automatisch Vortritt wie ein Linienbus.", ar:"أي مركبة تخرج من جيب توقف لها الأولوية تلقائياً كحافلة خط."}], correct:[0,1],
  e:{de:"Die Sonderregel gilt gezielt für Busse an gekennzeichneten Haltestellen, nicht generell.", ar:"القاعدة الخاصة تسري تحديداً للحافلات عند المواقف المعلَّمة، لا بشكل عام."}},
{ c:"vortritt", q:{de:"Beim Verlassen eines Parkhauses triffst du auf eine Strasse mit Rechtsvortritt.", ar:"عند مغادرة مرآب تصل إلى طريق بأولوية اليمين."}, a:[
  {de:"Die Ausfahrt aus dem Parkhaus gibt dir keinen Vortritt.", ar:"مخرج المرآب لا يمنحك أولوية."},{de:"Du musst dich wie aus jeder anderen Grundstückszufahrt einordnen.", ar:"عليك الاندماج كما من أي مدخل ملكية آخر."},{de:"Parkhausausfahrten haben grundsätzlich immer Vortritt gegenüber der öffentlichen Strasse.", ar:"لمخارج المرائب أصلاً الأولوية دائماً على الطريق العام."}], correct:[0,1],
  e:{de:"Das gilt unabhängig davon, wie gross oder wichtig das Parkhaus wirkt.", ar:"ينطبق ذلك بصرف النظر عن حجم المرآب أو أهميته الظاهرة."}},
{ c:"vortritt", q:{de:"Du bist zu Fuss unterwegs und ein Fahrzeug fährt rückwärts aus einer Einfahrt direkt in deine Richtung.", ar:"أنت تمشي، ومركبة تخرج للخلف من مدخل مباشرة نحوك."}, a:[
  {de:"Rückwärtsfahrende Fahrzeuge haben keinen Vortritt vor dir.", ar:"ليس للمركبات التي تخرج للخلف أولوية عليك."},{de:"Trotzdem ist es sicherer, dich bemerkbar zu machen oder auszuweichen.", ar:"رغم ذلك من الأأمن أن تجعل نفسك ملحوظاً أو تنحرف."},{de:"Als Fussgänger musst du in dieser Situation immer automatisch weichen.", ar:"بصفتك مشاة عليك دائماً الانحراف تلقائياً في هذا الموقف."}], correct:[0,1],
  e:{de:"Der Fahrer sieht dich beim Rückwärtsfahren möglicherweise nicht rechtzeitig.", ar:"قد لا يراك السائق في الوقت المناسب أثناء الرجوع للخلف."}},
{ c:"vortritt", q:{de:"An einer Verzweigung ohne Signale nähern sich drei Fahrzeuge gleichzeitig aus drei verschiedenen Richtungen.", ar:"عند تقاطع بلا إشارات تقترب ثلاث مركبات في آن واحد من ثلاثة اتجاهات مختلفة."}, a:[
  {de:"Der Rechtsvortritt lässt sich paarweise zwischen den Fahrzeugen anwenden.", ar:"يمكن تطبيق أولوية اليمين بين المركبات كل اثنتين على حدة."},{de:"Bei Unklarheit lieber kurz warten und sich per Blickkontakt verständigen.", ar:"عند الغموض من الأفضل الانتظار قليلاً والتفاهم بالنظر."},{de:"Bei drei Fahrzeugen gleichzeitig gilt keine Vortrittsregel mehr.", ar:"لا تنطبق أي قاعدة أولوية بعد الآن مع وجود ثلاث مركبات في آن واحد."}], correct:[0,1],
  e:{de:"Der Rechtsvortritt funktioniert auch bei mehreren Fahrzeugen, wenn man ihn Fahrzeug für Fahrzeug betrachtet.", ar:"تعمل أولوية اليمين أيضاً مع عدة مركبات إذا نُظر إليها مركبة بمركبة."}},

// ---------- manoever (Runde 4) ----------
{ c:"manoever", q:{de:"Du willst in einer Tempo-30-Zone ein parkiertes Fahrzeug überholen, Gegenverkehr ist möglich.", ar:"تريد تجاوز مركبة متوقفة في منطقة 30، وقد يوجد سير مقابل."}, a:[
  {de:"Auch in der Tempo-30-Zone gelten die normalen Überholregeln.", ar:"تنطبق قواعد التجاوز العادية أيضاً في منطقة 30."},{de:"Ausreichend Sicht und Platz sind weiterhin Voraussetzung.", ar:"تبقى الرؤية والمساحة الكافيتان شرطاً."},{de:"In Tempo-30-Zonen ist Überholen wegen der niedrigen Geschwindigkeit grundsätzlich immer risikofrei.", ar:"في مناطق 30 التجاوز بلا مخاطر دائماً أصلاً بسبب انخفاض السرعة."}], correct:[0,1],
  e:{de:"Tieferes Tempo verringert das Risiko, hebt es aber nicht vollständig auf.", ar:"السرعة الأقل تُقلّل الخطر لكنها لا تُلغيه تماماً."}},
{ c:"manoever", q:{de:"Du willst mit einem Anhänger in eine enge Parklücke rückwärts einparken.", ar:"تريد الركن للخلف بمقطورة في موقف ضيّق."}, a:[
  {de:"Das Fahrverhalten mit Anhänger unterscheidet sich deutlich von einem Fahrzeug allein.", ar:"يختلف سلوك القيادة مع مقطورة بشكل واضح عن مركبة بمفردها."},{de:"Bei Unsicherheit eine einweisende Person hinzuziehen.", ar:"استعن بمن يوجّهك عند عدم اليقين."},{de:"Ein Anhänger verhält sich beim Rückwärtsfahren exakt gleich wie das Zugfahrzeug allein.", ar:"تتصرف المقطورة أثناء الرجوع للخلف تماماً كالمركبة الجارّة بمفردها."}], correct:[0,1],
  e:{de:"Anhänger reagieren beim Lenken oft gegenläufig zur Intuition.", ar:"غالباً ما تستجيب المقطورات أثناء التوجيه بشكل معاكس للحدس."}},
{ c:"manoever", q:{de:"Du fährst durch eine Verkehrsberuhigungszone mit mehreren Aufpflasterungen und Schwellen.", ar:"تسير عبر منطقة تهدئة مرور بها عدة مطبات ومرتفعات."}, a:[
  {de:"Solche Elemente sollen die Geschwindigkeit natürlich reduzieren.", ar:"تهدف هذه العناصر إلى تخفيض السرعة بشكل طبيعي."},{de:"Angepasstes, langsames Tempo verhindert Schäden am Fahrzeug und erhöht die Sicherheit.", ar:"السرعة المخفضة والمناسبة تمنع أضرار المركبة وتزيد الأمان."},{de:"Aufpflasterungen sind reine Dekoration ohne Einfluss auf sinnvolles Fahrverhalten.", ar:"المرتفعات مجرد زخرفة بلا تأثير على السلوك المناسب للقيادة."}], correct:[0,1],
  e:{de:"Zu schnelles Überfahren kann zudem die Fahrzeugtechnik beschädigen.", ar:"قد يُتلف العبور بسرعة زائدة أيضاً تقنية المركبة."}},
{ c:"manoever", q:{de:"An einer Kreuzung willst du gleichzeitig rechts abbiegen, während ein Fussgänger den Streifen der Zielstrasse betritt.", ar:"عند تقاطع تريد الانعطاف يميناً في الوقت الذي يدخل فيه مشاة ممر الطريق الهدف."}, a:[
  {de:"Der Fussgänger auf dem Streifen hat weiterhin Vortritt.", ar:"لا يزال للمشاة على الممر الأولوية."},{de:"Das Abbiegen selbst hebt den Fussgängervortritt nicht auf.", ar:"الانعطاف نفسه لا يُلغي أولوية المشاة."},{de:"Beim Abbiegen darfst du zügig vor dem Fussgänger durchfahren, wenn du zuerst da warst.", ar:"يمكنك العبور بسرعة قبل المشاة عند الانعطاف إذا وصلت أولاً."}], correct:[0,1],
  e:{de:"Abbiegende Fahrzeuge müssen Fussgänger auf der Zielstrasse durchlassen.", ar:"يجب على المركبات المنعطفة السماح للمشاة على الطريق الهدف بالعبور."}},
{ c:"manoever", q:{de:"Du willst auf einer breiten Strasse mit Radstreifen ein haltendes Fahrzeug überholen, das teilweise auf den Radstreifen ragt.", ar:"تريد تجاوز مركبة متوقفة تمتد جزئياً إلى مسرب الدراجات على طريق واسع."}, a:[
  {de:"Nicht in den Radstreifen ausweichen, wenn dort Velofahrer unterwegs sein könnten.", ar:"لا تنحرف إلى مسرب الدراجات إذا كان قد يوجد راكبو دراجات فيه."},{de:"Ausreichend Sicherheitsabstand zum haltenden Fahrzeug einhalten.", ar:"حافظ على مسافة أمان كافية عن المركبة المتوقفة."},{de:"Der Radstreifen darf für ein kurzes Überholmanöver problemlos mitbenutzt werden.", ar:"يمكن استخدام مسرب الدراجات بلا مشكلة لمناورة تجاوز قصيرة."}], correct:[0,1],
  e:{de:"Ein plötzlich auftauchender Velofahrer im Radstreifen kann sonst gefährdet werden.", ar:"قد يتعرض راكب دراجة يظهر فجأة في المسرب للخطر وإلا."}},
{ c:"manoever", q:{de:"Du willst dein Fahrzeug in einer schmalen Quartierstrasse wenden, direkt gegenüber liegt eine Hauseinfahrt.", ar:"تريد الاستدارة في شارع ضيّق بالحي، ويقع مدخل منزل مباشرة في المقابل."}, a:[
  {de:"Die Hauseinfahrt darf beim Wendemanöver nicht blockiert werden.", ar:"يجب ألا يُسدّ مدخل المنزل أثناء مناورة الاستدارة."},{de:"Ausreichend Platz und freie Sicht sind Voraussetzung für das Wenden.", ar:"المساحة الكافية والرؤية الخالية شرط للاستدارة."},{de:"Eine private Hauseinfahrt darf für ein kurzes Wendemanöver kurzzeitig mitbenutzt werden.", ar:"يمكن استخدام مدخل منزل خاص لفترة قصيرة أثناء مناورة استدارة سريعة."}], correct:[0,1],
  e:{de:"Private Zufahrten müssen jederzeit nutzbar bleiben.", ar:"يجب أن تبقى المداخل الخاصة قابلة للاستخدام في كل الأوقات."}},

// ---------- autobahn (Runde 4) ----------
{ c:"autobahn", q:{de:"Auf der Autobahn ist ein Fahrstreifen wegen einer Panne eines anderen Fahrzeugs blockiert, du musst die Spur wechseln.", ar:"مسرب مسدود بسبب عطل مركبة أخرى على الأوتوستراد، وعليك تغيير المسرب."}, a:[
  {de:"Frühzeitig blinken und den Wechsel ankündigen.", ar:"استعمل الغماز مبكراً وأعلن عن التغيير."},{de:"Anderen Fahrzeugen beim Einfädeln nach Möglichkeit Platz machen.", ar:"أفسح المجال للمركبات الأخرى عند الاندماج إن أمكن."},{de:"Bei einer Panne eines anderen Fahrzeugs hast du automatisch Vortritt beim Spurwechsel.", ar:"عند عطل مركبة أخرى لك الأولوية تلقائياً عند تغيير المسرب."}], correct:[0,1],
  e:{de:"Gegenseitige Rücksicht verhindert an solchen Engstellen zusätzliche Unfälle.", ar:"المراعاة المتبادلة تمنع حوادث إضافية عند هذه الاختناقات."}},
{ c:"autobahn", q:{de:"Du fährst mit einem sehr leisen Elektrofahrzeug auf der Autobahn und bemerkst kaum, wie schnell du wirklich bist.", ar:"تقود مركبة كهربائية هادئة جداً على الأوتوستراد وبالكاد تلاحظ سرعتك الحقيقية."}, a:[
  {de:"Leise Fahrzeuge können das Geschwindigkeitsgefühl verfälschen.", ar:"قد تُشوّه المركبات الهادئة الإحساس بالسرعة."},{de:"Regelmässiger Blick auf den Tacho ist deshalb wichtig.", ar:"لذلك النظر المنتظم إلى العداد مهم."},{de:"Elektrofahrzeuge vermitteln automatisch immer ein korrektes Geschwindigkeitsgefühl.", ar:"تمنح المركبات الكهربائية دائماً وتلقائياً إحساساً صحيحاً بالسرعة."}], correct:[0,1],
  e:{de:"Ohne Motorengeräusch fehlt ein gewohntes akustisches Signal für die Geschwindigkeit.", ar:"بلا صوت محرك تغيب إشارة سمعية معتادة للسرعة."}},
{ c:"autobahn", q:{de:"Auf der Autobahn siehst du eine Anzeige mit einer variablen Geschwindigkeitsbeschränkung, die tiefer ist als die normale Höchstgeschwindigkeit.", ar:"ترى على الأوتوستراد لوحة بحد سرعة متغير أقل من السرعة القصوى العادية."}, a:[
  {de:"Solche Anzeigen reagieren oft auf aktuelle Verkehrs- oder Wetterbedingungen.", ar:"غالباً ما تستجيب هذه اللوحات لظروف السير أو الطقس الحالية."},{de:"Die angezeigte, tiefere Geschwindigkeit ist verbindlich.", ar:"السرعة المخفضة المعروضة ملزمة."},{de:"Variable Anzeigen sind unverbindliche Empfehlungen, die normale Höchstgeschwindigkeit bleibt massgebend.", ar:"اللوحات المتغيرة توصيات غير ملزمة، وتبقى السرعة القصوى العادية هي المعتمدة."}], correct:[0,1],
  e:{de:"Solche Systeme dienen der Sicherheit bei Stau, Nässe oder hohem Verkehrsaufkommen.", ar:"تخدم هذه الأنظمة السلامة عند الازدحام أو البلل أو كثافة السير."}},
{ c:"autobahn", q:{de:"Beim Verlassen der Autobahn über die Ausfahrt ist die Kurve enger als erwartet.", ar:"عند مغادرة الأوتوستراد عبر المخرج، المنعطف أضيق من المتوقع."}, a:[
  {de:"Bereits vor der Ausfahrt das Tempo rechtzeitig reduzieren.", ar:"خفّض السرعة في الوقت المناسب قبل المخرج."},{de:"Ausfahrten dürfen nicht mit Autobahntempo befahren werden.", ar:"لا يجوز السير في المخارج بسرعة الأوتوستراد."},{de:"Ausfahrtskurven sind grundsätzlich immer für das volle Autobahntempo ausgelegt.", ar:"مصممة منعطفات المخارج أصلاً دائماً لتحمل سرعة الأوتوستراد الكاملة."}], correct:[0,1],
  e:{de:"Viele Unfälle passieren, weil das Tempo beim Verlassen der Autobahn zu spät reduziert wird.", ar:"تقع حوادث كثيرة بسبب تخفيض السرعة متأخراً جداً عند مغادرة الأوتوستراد."}},

// ---------- mensch (Runde 4) ----------
{ c:"mensch", q:{de:"Du hast eine Sonnenallergie und nimmst dagegen ein Antihistaminikum ein.", ar:"لديك حساسية من الشمس وتتناول دواء مضاداً للهيستامين لعلاجها."}, a:[
  {de:"Manche Antihistaminika können müde machen.", ar:"بعض مضادات الهيستامين قد تُسبب النعاس."},{de:"Beipackzettel auf Warnhinweise zum Fahren prüfen.", ar:"تحقق من النشرة الداخلية بحثاً عن تحذيرات بشأن القيادة."},{de:"Allergiemedikamente haben grundsätzlich nie einen Einfluss auf die Fahrfähigkeit.", ar:"أدوية الحساسية لا تؤثر أصلاً أبداً على القدرة على القيادة."}], correct:[0,1],
  e:{de:"Es gibt deutliche Unterschiede zwischen verschiedenen Wirkstoffen und Generationen dieser Medikamente.", ar:"توجد فروق واضحة بين المواد الفعالة وأجيال هذه الأدوية المختلفة."}},
{ c:"mensch", q:{de:"Du fährst kurz nach einer emotional belastenden Nachricht, die du gerade erhalten hast.", ar:"تقود بُعيد تلقيك خبراً مرهقاً عاطفياً للتو."}, a:[
  {de:"Starke Emotionen können die Konzentration auf den Verkehr verringern.", ar:"قد تُقلّل المشاعر القوية التركيز على حركة السير."},{de:"Ein kurzer Moment zum Durchatmen vor der Fahrt kann helfen.", ar:"لحظة قصيرة لالتقاط الأنفاس قبل القيادة قد تساعد."},{de:"Emotionale Belastung hat auf die Fahrsicherheit erwiesenermassen keinerlei Einfluss.", ar:"من المؤكد أن الضغط العاطفي ليس له أي تأثير على سلامة القيادة."}], correct:[0,1],
  e:{de:"Ablenkung durch Gedanken ist eine ebenso reale Gefahr wie äussere Ablenkung.", ar:"التشتت بسبب الأفكار خطر حقيقي بقدر التشتت الخارجي."}},
{ c:"mensch", q:{de:"Du planst eine lange Reise und möchtest die Route vorher gut kennen.", ar:"تخطط لرحلة طويلة وتريد معرفة الطريق جيداً مسبقاً."}, a:[
  {de:"Vorausplanung reduziert Stress und spontane, riskante Entscheidungen während der Fahrt.", ar:"التخطيط المسبق يُقلّل التوتر والقرارات العفوية الخطرة أثناء القيادة."},{de:"Pausenorte und Tankstopps im Voraus zu kennen ist hilfreich.", ar:"معرفة أماكن الاستراحة والتزوّد بالوقود مسبقاً مفيد."},{de:"Eine gute Planung im Voraus hat auf die Fahrsicherheit selbst keinerlei Einfluss.", ar:"للتخطيط الجيد المسبق لا تأثير إطلاقاً على سلامة القيادة نفسها."}], correct:[0,1],
  e:{de:"Wer die Route kennt, muss unterwegs weniger nach dem Weg suchen und ist weniger abgelenkt.", ar:"من يعرف الطريق يبحث أقل عن الاتجاه أثناء السير ويكون أقل تشتتاً."}},
{ c:"mensch", q:{de:"Du hast eine Brille für die Fahrt vergessen, mit der du laut Führerausweis fahren musst.", ar:"نسيت النظارة التي تُلزمك رخصتك بارتدائها أثناء القيادة."}, a:[
  {de:"Ohne die vorgeschriebene Sehhilfe ist Fahren nicht zulässig.", ar:"القيادة بلا وسيلة التصحيح المطلوبة غير جائزة."},{de:"Besser eine Alternative suchen, als ohne Brille loszufahren.", ar:"من الأفضل البحث عن بديل بدل الانطلاق بلا النظارة."},{de:"Eine im Ausweis vermerkte Brillenpflicht ist eine reine Empfehlung ohne rechtliche Bedeutung.", ar:"إلزامية النظارة المذكورة في الرخصة مجرد توصية بلا أهمية قانونية."}], correct:[0,1],
  e:{de:"Eingeschränkte Sicht ohne die nötige Korrektur erhöht das Unfallrisiko erheblich.", ar:"الرؤية المحدودة بلا التصحيح اللازم تزيد خطر الحوادث بشكل كبير."}},

// ---------- fahrzeug (Runde 4) ----------
{ c:"fahrzeug", q:{de:"Deine Frontscheibe beschlägt plötzlich stark von innen während der Fahrt.", ar:"يتضبب زجاجك الأمامي من الداخل بشدة وفجأة أثناء القيادة."}, a:[
  {de:"Lüftung und Entfroster einschalten, um die Sicht rasch wiederherzustellen.", ar:"شغّل التهوية ومزيل الضباب لاستعادة الرؤية بسرعة."},{de:"Bei stark eingeschränkter Sicht wenn nötig sicher anhalten.", ar:"توقف بأمان عند الحاجة إذا كانت الرؤية محدودة بشدة."},{de:"Beschlagene Scheiben haben keinen relevanten Einfluss auf die Fahrsicherheit.", ar:"للزجاج المتضبب لا تأثير يُذكر على سلامة القيادة."}], correct:[0,1],
  e:{de:"Fahren mit stark eingeschränkter Sicht ist ausserordentlich gefährlich.", ar:"القيادة برؤية محدودة بشدة خطيرة جداً."}},
{ c:"fahrzeug", q:{de:"Ein Warnlämpchen für den Motorölstand leuchtet während der Fahrt kurz auf.", ar:"يضيء ضوء تحذير مستوى زيت المحرك للحظة أثناء القيادة."}, a:[
  {de:"Bei nächster Gelegenheit den Ölstand kontrollieren.", ar:"تحقق من مستوى الزيت عند أول فرصة."},{de:"Zu wenig Öl kann den Motor ernsthaft beschädigen.", ar:"قد يُلحق نقص الزيت ضرراً جدياً بالمحرك."},{de:"Ein kurzes Aufleuchten dieser Leuchte ist immer bedeutungslos.", ar:"وميض هذا الضوء لفترة قصيرة عديم الأهمية دائماً."}], correct:[0,1],
  e:{de:"Öl schützt den Motor vor Reibung, ein Mangel kann teure Folgeschäden verursachen.", ar:"يحمي الزيت المحرك من الاحتكاك، ونقصه قد يسبب أضراراً لاحقة مكلفة."}},
{ c:"fahrzeug", q:{de:"Du bemerkst, dass die Lenkung deines Fahrzeugs sich ungewöhnlich schwergängig anfühlt.", ar:"تلاحظ أن توجيه مركبتك أصبح ثقيلاً بشكل غير معتاد."}, a:[
  {de:"Das kann auf ein technisches Problem der Servolenkung hinweisen.", ar:"قد يُشير ذلك إلى مشكلة تقنية في نظام التوجيه المُعان."},{de:"Eine Kontrolle in einer Fachwerkstatt ist ratsam.", ar:"يُنصح بفحصها لدى ورشة متخصصة."},{de:"Eine schwergängige Lenkung ist normal und braucht nie kontrolliert zu werden.", ar:"التوجيه الثقيل طبيعي ولا يحتاج أبداً للفحص."}], correct:[0,1],
  e:{de:"Eine defekte Servolenkung kann die Reaktionsfähigkeit in Notsituationen einschränken.", ar:"قد يُقيّد عطل التوجيه المُعان القدرة على رد الفعل في حالات الطوارئ."}},

// ---------- umwelt (Runde 4) ----------
{ c:"umwelt", q:{de:"Du bemerkst, dass dein Fahrzeug im Stand beim Ampelstopp länger als eine Minute steht.", ar:"تلاحظ أن مركبتك تقف أكثر من دقيقة عند التوقف عند الإشارة."}, a:[
  {de:"Bei längerem Stillstand lohnt sich das Abstellen des Motors.", ar:"عند التوقف الطويل يستحق الأمر إطفاء المحرك."},{de:"Unnötiger Leerlauf verbraucht Treibstoff ohne Nutzen.", ar:"التشغيل الفارغ غير الضروري يستهلك وقوداً بلا فائدة."},{de:"Der Motor im Leerlauf verbraucht praktisch keinen Treibstoff.", ar:"يستهلك المحرك في وضع الخمول عملياً لا شيء تقريباً من الوقود."}], correct:[0,1],
  e:{de:"Über den Tag summiert sich unnötiger Leerlauf zu spürbarem Mehrverbrauch.", ar:"يتراكم التشغيل الفارغ غير الضروري خلال اليوم إلى استهلاك إضافي ملموس."}},
{ c:"umwelt", q:{de:"Du planst den Kauf eines neuen Fahrzeugs und überlegst dir die Grösse.", ar:"تخطط لشراء مركبة جديدة وتفكّر في حجمها."}, a:[
  {de:"Ein Fahrzeug, das zum tatsächlichen Bedarf passt, ist oft ökologisch sinnvoller.", ar:"المركبة المناسبة للحاجة الفعلية غالباً أكثر منطقية بيئياً."},{de:"Grössere, schwerere Fahrzeuge verbrauchen tendenziell mehr.", ar:"تستهلك المركبات الأكبر والأثقل عادة أكثر."},{de:"Die Fahrzeuggrösse hat auf den durchschnittlichen Verbrauch keinerlei Einfluss.", ar:"لحجم المركبة لا تأثير إطلاقاً على متوسط الاستهلاك."}], correct:[0,1],
  e:{de:"Gewicht und Luftwiderstand steigen meist mit der Fahrzeuggrösse.", ar:"يزداد الوزن ومقاومة الهواء عادة مع حجم المركبة."}},

// ---------- notfall (Runde 4) ----------
{ c:"notfall", q:{de:"Nach einem Unfall bist du selbst leicht benommen, aber ansprechbar, und musst Hilfe organisieren.", ar:"بعد حادث أنت نفسك مترنّح قليلاً لكنك واعٍ وعليك تنظيم المساعدة."}, a:[
  {de:"Zuerst dich selbst und andere aus dem Gefahrenbereich bringen.", ar:"انقل نفسك والآخرين أولاً بعيداً عن منطقة الخطر."},{de:"Auch bei eigener Benommenheit möglichst ruhig und strukturiert vorgehen.", ar:"تصرّف بهدوء ومنهجية قدر الإمكان حتى مع ترنّحك."},{de:"Eigene leichte Symptome nach einem Unfall kann man immer vollständig ignorieren.", ar:"يمكن دائماً تجاهل الأعراض الطفيفة لديك بعد الحادث تماماً."}], correct:[0,1],
  e:{de:"Auch scheinbar leichte Kopfverletzungen sollten ärztlich abgeklärt werden.", ar:"يجب أن يفحص الطبيب حتى إصابات الرأس التي تبدو طفيفة."}},
{ c:"notfall", q:{de:"An einer Unfallstelle im Tunnel gibt es Rauchentwicklung.", ar:"في مكان حادث داخل نفق يتصاعد دخان."}, a:[
  {de:"Fahrzeug möglichst zur Seite stellen und Warnblinker einschalten.", ar:"ضع المركبة جانباً قدر الإمكان وشغّل أضواء التحذير."},{de:"Den Tunnel zu Fuss in Fahrtrichtung zum nächsten Notausgang verlassen.", ar:"غادر النفق سيراً باتجاه السير نحو أقرب مخرج طوارئ."},{de:"Bei Rauch im Tunnel sollte man immer im Fahrzeug auf Hilfe warten.", ar:"عند الدخان في النفق يجب دائماً الانتظار داخل المركبة للمساعدة."}], correct:[0,1],
  e:{de:"Tunnel haben in regelmässigen Abständen gekennzeichnete Notausgänge.", ar:"تحتوي الأنفاق على مخارج طوارئ معلَّمة على مسافات منتظمة."}},
{ c:"notfall", q:{de:"Du kommst zu einem Unfall, bei dem ein Fahrzeug bereits leicht zu brennen beginnt und Personen noch im Auto sitzen.", ar:"تصل إلى حادث بدأت فيه مركبة بالاشتعال بينما لا يزال أشخاص بداخلها."}, a:[
  {de:"Bei unmittelbarer Gefahr dürfen Verletzte ausnahmsweise bewegt werden.", ar:"يمكن استثنائياً تحريك المصابين عند وجود خطر مباشر."},{de:"Sofort die Feuerwehr alarmieren.", ar:"اتصل بالإطفاء فوراً."},{de:"Verletzte dürfen unter keinen Umständen jemals bewegt werden, auch nicht bei Feuer.", ar:"لا يجوز أبداً تحت أي ظرف تحريك المصابين، حتى عند الحريق."}], correct:[0,1],
  e:{de:"Die sonst geltende Regel «nicht bewegen» weicht bei akuter Lebensgefahr wie Feuer.", ar:"تتراجع قاعدة «عدم التحريك» المعتادة عند خطر مباشر على الحياة كالحريق."}},
{ c:"notfall", q:{de:"Du willst einer Person nach einem Sturz vom Velo helfen, die über Schmerzen im Arm klagt, aber ansprechbar ist.", ar:"تريد مساعدة شخص سقط عن دراجته يشتكي من ألم بالذراع لكنه واعٍ."}, a:[
  {de:"Den Arm nicht gewaltsam bewegen oder strecken.", ar:"لا تُحرّك الذراع بالقوة ولا تمدّها."},{de:"Bei Verdacht auf einen Bruch professionelle Hilfe alarmieren.", ar:"استدعِ مساعدة متخصصة عند الشك بكسر."},{de:"Ein schmerzender Arm nach einem Sturz ist immer harmlos und braucht keine weitere Beachtung.", ar:"الذراع المؤلمة بعد السقوط غير خطيرة دائماً ولا تحتاج اهتماماً إضافياً."}], correct:[0,1],
  e:{de:"Unsachgemässe Bewegung kann eine mögliche Fraktur verschlimmern.", ar:"قد تُفاقم الحركة غير الصحيحة كسراً محتملاً."}},

// ---------- ausweis (Runde 4) ----------
{ c:"ausweis", q:{de:"Du hast während der Probezeit einen Wohnsitzwechsel in einen anderen Kanton.", ar:"غيّرت مكان إقامتك خلال فترة التجربة إلى كانتون آخر."}, a:[
  {de:"Die Probezeit und ihre Regeln bleiben trotz Umzugs gültig.", ar:"تبقى فترة التجربة وقواعدها سارية رغم الانتقال."},{de:"Die neue Wohnsitzbehörde sollte informiert werden.", ar:"يجب إبلاغ سلطة الإقامة الجديدة."},{de:"Ein Kantonswechsel setzt die Probezeit automatisch auf null zurück.", ar:"يُعيد تغيير الكانتون فترة التجربة إلى الصفر تلقائياً."}], correct:[0,1],
  e:{de:"Der Führerausweis auf Probe ist national gültig, nicht nur im Ausstellungskanton.", ar:"الرخصة التجريبية سارية على المستوى الوطني، لا في كانتون الإصدار فقط."}},
{ c:"ausweis", q:{de:"Du willst wissen, wie lange dein Nothelferausweis noch gültig ist.", ar:"تريد معرفة صلاحية شهادة الإسعافات الأولية المتبقية لك."}, a:[
  {de:"Der Nothelferkurs ist in der Regel 6 Jahre gültig.", ar:"دورة الإسعافات الأولية صالحة عادة 6 سنوات."},{de:"Bei Ablauf während der Ausbildung kann eine Auffrischung nötig sein.", ar:"عند انتهاء الصلاحية خلال التدريب قد يلزم تجديد الدورة."},{de:"Ein einmal absolvierter Nothelferkurs ist ein Leben lang ohne jede Einschränkung gültig.", ar:"دورة الإسعافات المُنجزة مرة واحدة صالحة مدى الحياة بلا أي قيد."}], correct:[0,1],
  e:{de:"Es lohnt sich, das Datum des eigenen Kurses im Blick zu behalten.", ar:"يستحق الأمر متابعة تاريخ دورتك الخاصة."}},
{ c:"ausweis", q:{de:"Du hast eine Verwarnung erhalten und fragst dich, was das für deinen Führerausweis bedeutet.", ar:"تلقيت إنذاراً وتتساءل عن معناه بالنسبة لرخصتك."}, a:[
  {de:"Eine Verwarnung ist milder als ein Ausweisentzug, aber trotzdem ernst zu nehmen.", ar:"الإنذار أخف من سحب الرخصة، لكن يجب أخذه على محمل الجد رغم ذلك."},{de:"Wiederholtes Fehlverhalten kann zu strengeren Massnahmen führen.", ar:"قد يؤدي تكرار السلوك الخاطئ إلى إجراءات أشد."},{de:"Eine Verwarnung hat rechtlich absolut keine Bedeutung und kann ignoriert werden.", ar:"ليس للإنذار أي أهمية قانونية إطلاقاً ويمكن تجاهله."}], correct:[0,1],
  e:{de:"Verwarnungen sind Teil eines abgestuften Systems von Massnahmen.", ar:"الإنذارات جزء من نظام متدرّج من الإجراءات."}},

// ---------- verkehrsteilnehmer (Runde 4) ----------
{ c:"verkehrsteilnehmer", q:{de:"Ein Fahrzeug mit einem grossen Firmenlogo und sichtlich vollem Kofferraum fährt vor dir spürbar träge.", ar:"مركبة عليها شعار شركة كبير وصندوق ممتلئ بوضوح تسير أمامك ببطء ملحوظ."}, a:[
  {de:"Beruflich genutzte Fahrzeuge können schwer beladen und deshalb langsamer sein.", ar:"قد تكون المركبات المستخدمة مهنياً محمّلة بثقل وبالتالي أبطأ."},{de:"Grösseren Abstand und Geduld einplanen.", ar:"خطّط لمسافة أكبر وصبر إضافي."},{de:"Kommerziell genutzte Fahrzeuge fahren grundsätzlich immer genauso schnell wie leere Privatautos.", ar:"تسير المركبات التجارية أصلاً دائماً بنفس سرعة السيارات الخاصة الفارغة."}], correct:[0,1],
  e:{de:"Zuladung beeinflusst Beschleunigung und Bremsweg spürbar.", ar:"تؤثر الحمولة بشكل ملموس على التسارع ومسافة الكبح."}},
{ c:"verkehrsteilnehmer", q:{de:"Ein Fussgänger mit Kinderwagen wartet am Fahrbahnrand ohne markierten Streifen in der Nähe.", ar:"شخص بعربة أطفال ينتظر على حافة الطريق بلا ممر معلَّم قريب."}, a:[
  {de:"Formal besteht dort kein automatischer Vortritt.", ar:"لا توجد أولوية تلقائية رسمياً هناك."},{de:"Rücksichtsvolles Verhalten und gegebenenfalls Anhalten sind trotzdem sinnvoll.", ar:"التصرف المراعي والتوقف عند الحاجة منطقيان رغم ذلك."},{de:"Ein Kinderwagen ändert überhaupt nichts an der Situation gegenüber einem gewöhnlichen Fussgänger.", ar:"عربة الأطفال لا تغيّر شيئاً إطلاقاً عن حالة المشاة العاديين."}], correct:[0,1],
  e:{de:"Mit Kinderwagen ist das Überqueren oft langsamer und schwieriger.", ar:"العبور بعربة الأطفال غالباً أبطأ وأصعب."}},

// ---------- bahnuebergang (Runde 4) ----------
{ c:"bahnuebergang", q:{de:"Nachts näherst du dich einem unbeschrankten Bahnübergang, den du am Tag gut kennst.", ar:"تقترب ليلاً من معبر سكة بلا حاجز تعرفه جيداً نهاراً."}, a:[
  {de:"Auch bei bekannter Strecke volle Aufmerksamkeit beibehalten.", ar:"حافظ على الانتباه الكامل حتى مع معرفة الطريق."},{de:"Nachts ist ein herannahender Zug schwerer einzuschätzen.", ar:"يصعب تقدير قطار مقترب بشكل أكبر ليلاً."},{de:"Bekannte Bahnübergänge dürfen bei Dunkelheit routinemässig und ohne besondere Vorsicht befahren werden.", ar:"يمكن عبور معابر السكة المعروفة روتينياً بلا حذر خاص في الظلام."}], correct:[0,1],
  e:{de:"Routine kann nachts zu einer gefährlichen Unterschätzung der Situation führen.", ar:"قد تؤدي الروتينية ليلاً إلى تقليل خطير من شأن الموقف."}},

// ---------- parken_halten (Runde 4) ----------
{ c:"parken_halten", q:{de:"Du willst dein Fahrzeug direkt vor einem Fussgängerstreifen abstellen, weil kein anderer Platz sichtbar ist.", ar:"تريد ترك مركبتك مباشرة أمام ممر مشاة لعدم وجود مكان آخر ظاهر."}, a:[
  {de:"Der Mindestabstand von 5 m vor dem Streifen muss eingehalten werden.", ar:"يجب احترام المسافة الدنيا 5 أمتار قبل الممر."},{de:"Eine kurze Suche nach einem korrekten Platz lohnt sich.", ar:"يستحق الأمر البحث قليلاً عن مكان صحيح."},{de:"Fehlender sichtbarer Platz rechtfertigt ausnahmsweise das Parkieren direkt vor dem Streifen.", ar:"عدم وجود مكان ظاهر يبرر استثنائياً الركن مباشرة أمام الممر."}], correct:[0,1],
  e:{de:"Der Abstand schützt die Sicht auf Fussgänger für den übrigen Verkehr.", ar:"تحمي المسافة رؤية المشاة لبقية حركة السير."}},

// ---------- ladung_transport (Runde 4) ----------
{ c:"ladung_transport", q:{de:"Du planst, mit vollem Fahrzeug und zusätzlichem Dachgepäckträger eine lange Reise anzutreten.", ar:"تخطط لرحلة طويلة بمركبة ممتلئة وحمالة سقف إضافية."}, a:[
  {de:"Das zulässige Gesamtgewicht des Fahrzeugs darf nicht überschritten werden.", ar:"يجب عدم تجاوز الوزن الإجمالي المسموح للمركبة."},{de:"Auch die Dachlast hat eine spezifische Höchstgrenze.", ar:"للحمولة على السقف أيضاً حد أقصى محدد."},{de:"Solange die Ladung gut aussieht, spielt das Gewicht keine praktische Rolle.", ar:"طالما تبدو الحمولة جيدة، لا دور عملي للوزن."}], correct:[0,1],
  e:{de:"Die zulässigen Werte stehen im Fahrzeugausweis und in der Betriebsanleitung.", ar:"القيم المسموحة مذكورة في بطاقة المركبة ودليل الاستخدام."}},

,

// ---------- umwelt (Runde 5) ----------
{ c:"umwelt", q:{de:"Du überlegst, ob du für einen Termin in der Innenstadt das Auto oder den Zug nimmst.", ar:"تفكّر إن كنت ستستخدم السيارة أو القطار لموعد في وسط المدينة."}, a:[
  {de:"In dicht besiedelten Gebieten ist der öffentliche Verkehr oft ökologisch vorteilhaft.", ar:"في المناطق كثيفة السكان غالباً ما يكون النقل العام مفيداً بيئياً."},{de:"Parkplatzsuche mit dem Auto verursacht zusätzlichen unnötigen Verbrauch.", ar:"البحث عن موقف بالسيارة يسبب استهلاكاً إضافياً غير ضروري."},{de:"In der Innenstadt ist das Auto aus ökologischer Sicht immer die schnellere und bessere Wahl.", ar:"في وسط المدينة السيارة دائماً الخيار الأسرع والأفضل من الناحية البيئية."}], correct:[0,1],
  e:{de:"Stop-and-go-Verkehr und Parkplatzsuche erhöhen den Verbrauch pro gefahrenem Kilometer.", ar:"يزيد سير التوقف والانطلاق والبحث عن موقف الاستهلاك لكل كيلومتر مقطوع."}},
{ c:"umwelt", q:{de:"Du fährst mit angezogener Handbremse ein kurzes Stück, ohne es zu bemerken.", ar:"تسير مسافة قصيرة بفرملة يد مشدودة دون أن تلاحظ."}, a:[
  {de:"Das erhöht Verbrauch und Verschleiss erheblich.", ar:"يزيد ذلك الاستهلاك والتآكل بشكل كبير."},{de:"Regelmässige Kontrolllampen sollten beachtet werden.", ar:"يجب الانتباه لأضواء التحذير المنتظمة."},{de:"Eine leicht angezogene Handbremse hat auf Verbrauch und Bremsen keinerlei Einfluss.", ar:"لفرملة اليد المشدودة قليلاً لا تأثير إطلاقاً على الاستهلاك والفرامل."}], correct:[0,1],
  e:{de:"Zusätzlich kann das die Bremsen und Reifen stark abnutzen.", ar:"قد يُتلف ذلك الفرامل والإطارات بشدة إضافياً."}},
{ c:"umwelt", q:{de:"Du fährst regelmässig über sehr kurze Distanzen zum nahen Briefkasten oder Kiosk.", ar:"تقود بانتظام مسافات قصيرة جداً إلى صندوق البريد أو الكشك القريب."}, a:[
  {de:"Solche Kurzstrecken sind oft zu Fuss ähnlich schnell und viel umweltfreundlicher.", ar:"غالباً ما تكون هذه المسافات القصيرة سريعة بالمثل سيراً وأكثر مراعاة للبيئة بكثير."},{de:"Der Kaltstart des Motors macht diese Fahrten besonders ineffizient.", ar:"يجعل التشغيل البارد للمحرك هذه الرحلات غير فعّالة بشكل خاص."},{de:"Auf sehr kurzen Strecken verbraucht ein Auto anteilig weniger als auf langen Fahrten.", ar:"على المسافات القصيرة جداً تستهلك السيارة نسبياً أقل من الرحلات الطويلة."}], correct:[0,1],
  e:{de:"Pro Kilometer ist der Verbrauch bei Kurzstrecken überdurchschnittlich hoch.", ar:"الاستهلاك لكل كيلومتر أعلى من المعدل في الرحلات القصيرة."}},
{ c:"umwelt", q:{de:"Du reinigst dein Fahrzeug regelmässig und achtest dabei auf einen sparsamen Wasserverbrauch.", ar:"تنظّف مركبتك بانتظام وتنتبه لاستهلاك ماء موفّر."}, a:[
  {de:"Eine Waschanlage mit Wasseraufbereitung ist meist ressourcenschonender als Waschen von Hand auf der Strasse.", ar:"محطة الغسيل بمعالجة المياه عادة أوفر للموارد من الغسيل اليدوي في الشارع."},{de:"Reinigungsmittel können ins Grundwasser gelangen, wenn sie unkontrolliert abfliessen.", ar:"قد تصل مواد التنظيف إلى المياه الجوفية إذا تدفقت بلا ضبط."},{de:"Der Ort der Fahrzeugwäsche hat aus Umweltsicht keinerlei Bedeutung.", ar:"لمكان غسيل المركبة لا أهمية إطلاقاً من الناحية البيئية."}], correct:[0,1],
  e:{de:"Deshalb ist das Waschen auf öffentlichen Strassen in vielen Gemeinden eingeschränkt.", ar:"لهذا يُقيَّد الغسيل في الشوارع العامة في كثير من البلديات."}},
{ c:"umwelt", q:{de:"Du entscheidest dich für Reifen mit einer besseren Kraftstoffeffizienz-Klassierung.", ar:"تختار إطارات بتصنيف أفضل لكفاءة استهلاك الوقود."}, a:[
  {de:"Der Rollwiderstand von Reifen beeinflusst den Verbrauch spürbar.", ar:"تؤثر مقاومة تدحرج الإطارات على الاستهلاك بشكل ملموس."},{de:"Effizientere Reifen können über die Zeit Treibstoffkosten senken.", ar:"قد تُخفّض الإطارات الأكفأ تكاليف الوقود مع الوقت."},{de:"Alle Reifen haben unabhängig vom Modell exakt denselben Rollwiderstand.", ar:"لكل الإطارات بصرف النظر عن الطراز نفس مقاومة التدحرج تماماً."}], correct:[0,1],
  e:{de:"Die EU-Reifenkennzeichnung informiert unter anderem über die Effizienzklasse.", ar:"يُعلم تصنيف الإطارات الأوروبي من بين أمور أخرى عن فئة الكفاءة."}},

// ---------- ladung_transport (Runde 5) ----------
{ c:"ladung_transport", q:{de:"Du transportierst eine Leiter, die länger als das Fahrzeug ist, auf einem Dachträger.", ar:"تنقل سُلّماً أطول من المركبة على حمّالة السقف."}, a:[
  {de:"Überstehende Ladung muss deutlich sichtbar gekennzeichnet sein.", ar:"يجب تمييز الحمولة البارزة بوضوح."},{de:"Eine sichere Befestigung an mehreren Punkten ist wichtig.", ar:"التثبيت الآمن في عدة نقاط مهم."},{de:"Eine lange Leiter darf ohne jede Kennzeichnung beliebig weit über das Fahrzeug hinausragen.", ar:"يمكن للسُلّم الطويل أن يبرز عن المركبة بأي مقدار بلا أي تمييز."}], correct:[0,1],
  e:{de:"Unzureichend gesicherte lange Gegenstände sind eine erhebliche Gefahr für den übrigen Verkehr.", ar:"الأغراض الطويلة غير المثبتة بشكل كافٍ خطر كبير على بقية حركة السير."}},
{ c:"ladung_transport", q:{de:"Du transportierst mehrere Personen und Gepäck gleichzeitig und bist dir bei der Verteilung im Fahrzeug unsicher.", ar:"تنقل عدة أشخاص وأمتعة في آن واحد ولست متأكداً من توزيعها داخل المركبة."}, a:[
  {de:"Schwere Gegenstände möglichst tief und weit vorne im Kofferraum platzieren.", ar:"ضع الأغراض الثقيلة منخفضة وقريبة من الأمام في الصندوق قدر الإمكان."},{de:"Eine ausgewogene Gewichtsverteilung verbessert das Fahrverhalten.", ar:"التوزيع المتوازن للوزن يُحسّن سلوك القيادة."},{de:"Die Verteilung der Ladung im Fahrzeug hat auf das Fahrverhalten praktisch keinen Einfluss.", ar:"لتوزيع الحمولة داخل المركبة عملياً لا تأثير على سلوك القيادة."}], correct:[0,1],
  e:{de:"Einseitige oder zu weit hinten liegende Lasten können die Fahrstabilität verschlechtern.", ar:"الأحمال غير المتوازنة أو البعيدة جداً للخلف قد تُسيء إلى استقرار القيادة."}},
{ c:"ladung_transport", q:{de:"Ein Fahrgast auf dem Rücksitz möchte während der Fahrt kurz den Gurt lösen, um sich umzudrehen.", ar:"يريد راكب في المقعد الخلفي فكّ الحزام لحظياً أثناء القيادة ليستدير."}, a:[
  {de:"Der Gurt sollte während der Fahrt grundsätzlich angelegt bleiben.", ar:"يجب أن يبقى الحزام مربوطاً أساساً أثناء القيادة."},{de:"Selbst kurzes Lösen erhöht das Verletzungsrisiko bei einer plötzlichen Bremsung.", ar:"حتى الفكّ اللحظي يزيد خطر الإصابة عند كبح مفاجئ."},{de:"Für wenige Sekunden ist das Lösen des Gurts völlig unbedenklich.", ar:"فكّ الحزام لثوانٍ قليلة غير مقلق إطلاقاً."}], correct:[0,1],
  e:{de:"Unfälle passieren oft ohne Vorwarnung, gerade dann ist der Gurt entscheidend.", ar:"تقع الحوادث غالباً بلا إنذار مسبق، وعندها يكون الحزام حاسماً بالضبط."}},
{ c:"ladung_transport", q:{de:"Du transportierst einen grossen Hund lose auf der Rückbank ohne Trenngitter oder Gurt.", ar:"تنقل كلباً كبيراً بحرية على المقعد الخلفي بلا شبكة فاصلة أو حزام."}, a:[
  {de:"Ein grosses, ungesichertes Tier kann bei einem Aufprall erhebliche Kräfte entwickeln.", ar:"قد يُولّد حيوان كبير غير مثبّت قوى كبيرة عند الاصطدام."},{de:"Ein Hundegurt oder eine Box reduziert dieses Risiko deutlich.", ar:"يُقلّل حزام الكلب أو الصندوق هذا الخطر بشكل ملحوظ."},{de:"Ein Hund auf der Rückbank ist immer automatisch sicher genug ohne jede zusätzliche Sicherung.", ar:"الكلب على المقعد الخلفي آمن تلقائياً دائماً بما فيه الكفاية بلا أي تثبيت إضافي."}], correct:[0,1],
  e:{de:"Auch für Fahrer und Beifahrer stellt ein loses grosses Tier eine Gefahr dar.", ar:"يُشكّل الحيوان الكبير غير المثبّت خطراً أيضاً على السائق والراكب الأمامي."}},

// ---------- bahnuebergang (Runde 5) ----------
{ c:"bahnuebergang", q:{de:"Ein Bahnübergang liegt direkt nach einer scharfen Kurve, die Sicht auf die Gleise ist erst spät möglich.", ar:"يقع معبر سكة مباشرة بعد منعطف حاد، ولا تصبح رؤية القضبان ممكنة إلا متأخراً."}, a:[
  {de:"Bereits vor der Kurve das Tempo reduzieren.", ar:"خفّض السرعة قبل المنعطف بالفعل."},{de:"Mit wenig Reaktionszeit rechnen, sobald die Gleise sichtbar werden.", ar:"توقّع وقتاً قصيراً لرد الفعل بمجرد ظهور القضبان."},{de:"Eine Kurve vor dem Übergang hat auf die nötige Vorsicht keinerlei Einfluss.", ar:"للمنعطف قبل المعبر لا تأثير إطلاقاً على الحذر المطلوب."}], correct:[0,1],
  e:{de:"Eingeschränkte Sicht verlangt eine frühere Anpassung der Geschwindigkeit.", ar:"الرؤية المحدودة تتطلب تكيّفاً أبكر مع السرعة."}},
{ c:"bahnuebergang", q:{de:"An einem Bahnübergang mit Schranke bleibt diese ungewöhnlich lange geschlossen, ohne dass ein Zug sichtbar ist.", ar:"عند معبر سكة بحاجز، يبقى الحاجز مغلقاً لفترة طويلة بشكل غير معتاد بلا ظهور قطار."}, a:[
  {de:"Geduldig warten und die Schranke nicht umfahren.", ar:"انتظر بصبر ولا تلتف حول الحاجز."},{de:"Eine geschlossene Schranke bleibt verbindlich, auch wenn der Grund unklar ist.", ar:"يبقى الحاجز المغلق ملزماً حتى لو كان السبب غير واضح."},{de:"Nach ein paar Minuten Wartezeit darf die Schranke vorsichtig umfahren werden.", ar:"يمكن الالتفاف حول الحاجز بحذر بعد بضع دقائق انتظار."}], correct:[0,1],
  e:{de:"Technische Störungen oder mehrere Züge können die Schliesszeit verlängern.", ar:"قد تُطيل الأعطال التقنية أو عدة قطارات مدة الإغلاق."}},
{ c:"bahnuebergang", q:{de:"Du fährst mit einem langen Fahrzeuggespann und näherst dich einem unbeschrankten Bahnübergang mit wenig Platz danach.", ar:"تقود تركيبة مركبات طويلة وتقترب من معبر سكة بلا حاجز مع مساحة قليلة خلفه."}, a:[
  {de:"Vor dem Überqueren sicherstellen, dass wirklich genug Platz für die ganze Länge vorhanden ist.", ar:"تأكد قبل العبور من وجود مساحة كافية فعلاً لكامل الطول."},{de:"Im Zweifel lieber warten, statt das Risiko einzugehen.", ar:"عند الشك من الأفضل الانتظار بدل خوض المخاطرة."},{de:"Bei langen Fahrzeugen ist die Platzfrage hinter dem Übergang praktisch nie relevant.", ar:"مسألة المساحة خلف المعبر غير مهمة عملياً أبداً مع المركبات الطويلة."}], correct:[0,1],
  e:{de:"Ein zu langes Fahrzeug, das auf den Schienen stecken bleibt, ist besonders gefährlich.", ar:"المركبة الطويلة جداً العالقة على القضبان خطيرة بشكل خاص."}},

// ---------- parken_halten (Runde 5) ----------
{ c:"parken_halten", q:{de:"Du willst dein Fahrzeug in einer engen Quartierstrasse so parkieren, dass Rettungsfahrzeuge noch durchkommen.", ar:"تريد ركن مركبتك في شارع ضيّق بالحي بحيث تظل مركبات الإنقاذ قادرة على المرور."}, a:[
  {de:"Eine Mindestbreite für den Durchgangsverkehr muss frei bleiben.", ar:"يجب أن تبقى مساحة دنيا خالية لمرور السير."},{de:"Im Zweifel eher enger am Rand als mittig parkieren.", ar:"عند الشك اركن قريباً من الحافة لا في المنتصف."},{de:"Die Durchfahrtsbreite für Rettungsfahrzeuge ist beim privaten Parkieren ohne jede Bedeutung.", ar:"عرض ممر مركبات الإنقاذ ليس له أي أهمية عند الركن الخاص."}], correct:[0,1],
  e:{de:"Blockierte enge Strassen können im Notfall über Leben und Tod entscheiden.", ar:"قد تُقرر الشوارع الضيقة المسدودة بين الحياة والموت في حالات الطوارئ."}},
{ c:"parken_halten", q:{de:"Auf einem Parkplatz mit Ladestationen für Elektrofahrzeuge willst du mit einem Fahrzeug ohne Stecker kurz parkieren.", ar:"في موقف بمحطات شحن للمركبات الكهربائية، تريد الركن لحظياً بمركبة بلا قابس شحن."}, a:[
  {de:"Solche Plätze sind oft für ladende Elektrofahrzeuge reserviert.", ar:"غالباً ما تكون هذه المواقف محجوزة للمركبات الكهربائية أثناء الشحن."},{de:"Ein anderer, nicht reservierter Platz ist die korrekte Wahl.", ar:"موقف آخر غير محجوز هو الخيار الصحيح."},{de:"Ladestationsplätze dürfen von jedem Fahrzeug unabhängig vom Antrieb frei genutzt werden.", ar:"يمكن لأي مركبة استخدام مواقف الشحن بحرية بصرف النظر عن نوع الدفع."}], correct:[0,1],
  e:{de:"Das Blockieren solcher Plätze verhindert das Laden für andere.", ar:"سدّ هذه المواقف يمنع الآخرين من الشحن."}},
{ c:"parken_halten", q:{de:"Du parkierst regelmässig auf demselben öffentlichen Platz und behandelst ihn wie deinen privaten Stellplatz.", ar:"تركن بانتظام في نفس الموقف العام وتتعامل معه كموقفك الخاص."}, a:[
  {de:"Ein öffentlicher Parkplatz bleibt grundsätzlich für alle zugänglich.", ar:"يبقى الموقف العام أصلاً متاحاً للجميع."},{de:"Häufige Nutzung begründet kein exklusives Recht auf einen bestimmten Platz.", ar:"الاستخدام المتكرر لا يمنح حقاً حصرياً في موقف معين."},{de:"Regelmässiges Parkieren am gleichen Ort begründet nach einiger Zeit ein persönliches Vorrecht.", ar:"يُنشئ الركن المنتظم في نفس المكان امتيازاً شخصياً بعد فترة من الوقت."}], correct:[0,1],
  e:{de:"Öffentliche Parkplätze funktionieren nach dem Prinzip «wer zuerst kommt».", ar:"تعمل المواقف العامة وفق مبدأ «من يصل أولاً»."}},

// ---------- verkehrsteilnehmer (Runde 5) ----------
{ c:"verkehrsteilnehmer", q:{de:"Eine Gruppe Velofahrer fährt organisiert und geschlossen als Kolonne auf der Strasse.", ar:"مجموعة راكبي دراجات تسير منظمة ومتراصة كطابور على الطريق."}, a:[
  {de:"Geschlossene Kolonnen dürfen unter bestimmten Voraussetzungen als Einheit betrachtet werden.", ar:"يمكن اعتبار الطوابير المتراصة وحدة واحدة وفق شروط معينة."},{de:"Ein Überholen der ganzen Gruppe braucht besonders viel Platz und Sicht.", ar:"يحتاج تجاوز المجموعة كاملة مساحة ورؤية كبيرتين بشكل خاص."},{de:"Jeder einzelne Velofahrer einer Gruppe muss immer separat und einzeln überholt werden.", ar:"يجب دائماً تجاوز كل راكب دراجة في المجموعة على حدة وبشكل منفصل."}], correct:[0,1],
  e:{de:"Ein unvollständiges Überholmanöver mitten in der Gruppe ist besonders gefährlich.", ar:"مناورة تجاوز غير مكتملة وسط المجموعة خطيرة بشكل خاص."}},
{ c:"verkehrsteilnehmer", q:{de:"Ein Fussgänger mit Rollator bewegt sich sehr langsam über eine breite Kreuzung.", ar:"شخص بمشّاية يتحرك ببطء شديد عبر تقاطع واسع."}, a:[
  {de:"Auch bei knapper werdender Grünphase hat die Person weiterhin Vortritt.", ar:"لا يزال للشخص الأولوية حتى مع اقتراب انتهاء مرحلة الأخضر."},{de:"Geduld und Rücksicht sind hier besonders wichtig.", ar:"الصبر والمراعاة مهمان هنا بشكل خاص."},{de:"Bei einer Person mit Rollator darfst du die verbleibende Grünzeit grosszügig zu deinen Gunsten auslegen.", ar:"يمكنك مع شخص بمشّاية تفسير الوقت المتبقي من الأخضر بسخاء لصالحك."}], correct:[0,1],
  e:{de:"Mobilitätseingeschränkte Personen brauchen oft deutlich mehr Zeit zum Queren.", ar:"غالباً ما يحتاج الأشخاص محدودو الحركة وقتاً أطول بكثير للعبور."}},
{ c:"verkehrsteilnehmer", q:{de:"Auf einer schmalen Bergstrasse begegnest du einem Postauto, das laut Regel Vortritt hat.", ar:"على طريق جبلي ضيّق تلتقي بحافلة بريد لها الأولوية حسب القاعدة."}, a:[
  {de:"Postautos haben auf signalisierten Bergpoststrecken oft besonderen Vortritt.", ar:"غالباً ما يكون لحافلات البريد أولوية خاصة على طرق البريد الجبلية المُشار إليها."},{de:"Nötigenfalls an einer Ausweichstelle warten oder zurücksetzen.", ar:"انتظر عند نقطة تفادي أو ارجع للخلف عند الحاجة."},{de:"Auf Bergstrassen gilt für alle Fahrzeuge ausnahmslos die normale Rechtsvortrittsregel.", ar:"تسري على الطرق الجبلية قاعدة أولوية اليمين العادية للجميع بلا استثناء."}], correct:[0,1],
  e:{de:"Diese Sonderregel ist oft mit einem eigenen Signal gekennzeichnet.", ar:"غالباً ما تُشار هذه القاعدة الخاصة بإشارة خاصة بها."}, scene:"bergpost"},

// ---------- fahrzeug (Runde 5) ----------
{ c:"fahrzeug", q:{de:"Du bemerkst beim Fahren ein leichtes Ziehen des Fahrzeugs zur Seite, obwohl du geradeaus lenkst.", ar:"تلاحظ أثناء القيادة انجذاباً خفيفاً للمركبة نحو جانب رغم أنك توجّه مستقيماً."}, a:[
  {de:"Das kann auf ungleichen Reifendruck oder ein technisches Problem hinweisen.", ar:"قد يُشير ذلك إلى تفاوت ضغط الإطارات أو مشكلة تقنية."},{de:"Eine Kontrolle in einer Fachwerkstatt ist sinnvoll.", ar:"الفحص لدى ورشة متخصصة أمر منطقي."},{de:"Ein leichtes Ziehen zur Seite ist bei jedem Fahrzeug völlig normal und braucht nie geprüft zu werden.", ar:"الانجذاب الخفيف نحو جانب طبيعي تماماً في كل مركبة ولا يحتاج فحصاً أبداً."}], correct:[0,1],
  e:{de:"Solche Anzeichen können frühzeitig auf grössere technische Probleme hindeuten.", ar:"قد تُشير هذه العلامات مبكراً إلى مشاكل تقنية أكبر."}},
{ c:"fahrzeug", q:{de:"Deine Scheibenwischer hinterlassen bei Regen deutliche Schlieren auf der Frontscheibe.", ar:"تترك ممسحات زجاجك آثاراً واضحة على الزجاج الأمامي أثناء المطر."}, a:[
  {de:"Abgenutzte Wischerblätter können die Sicht bei Regen einschränken.", ar:"قد تُقيّد شفرات المسّاحات المهترئة الرؤية أثناء المطر."},{de:"Ein Austausch der Wischerblätter verbessert die Sicherheit.", ar:"استبدال شفرات المسّاحات يُحسّن السلامة."},{de:"Schlieren auf der Scheibe haben bei Regen keinerlei praktische Bedeutung für die Sicht.", ar:"لا أهمية عملية للآثار على الزجاج للرؤية أثناء المطر."}], correct:[0,1],
  e:{de:"Gerade bei Regen und Dunkelheit ist klare Sicht besonders entscheidend.", ar:"الرؤية الواضحة حاسمة بشكل خاص عند المطر والظلام."}},

// ---------- autobahn (Runde 5) ----------
{ c:"autobahn", q:{de:"Auf der Autobahn bemerkst du, dass dein Tank bald leer sein könnte, die nächste Raststätte ist weit entfernt.", ar:"تلاحظ على الأوتوستراد أن خزانك قد يفرغ قريباً، ومحطة الاستراحة التالية بعيدة."}, a:[
  {de:"Frühzeitig auf den Treibstoffstand achten, um solche Situationen zu vermeiden.", ar:"انتبه مبكراً لمستوى الوقود لتجنّب مثل هذه المواقف."},{de:"Bei knappem Tank vorausschauend und sparsam fahren.", ar:"قُد باستباقية واقتصاد عند نقص الوقود."},{de:"Auf der Autobahn liegend liegen bleiben ist bei leerem Tank ein normaler, unproblematischer Vorgang.", ar:"التوقف على الأوتوستراد بسبب نفاد الوقود أمر طبيعي وغير مُقلق."}], correct:[0,1],
  e:{de:"Liegenbleiben auf der Autobahn ist gefährlich und sollte durch vorausschauendes Planen vermieden werden.", ar:"التوقف على الأوتوستراد خطير ويجب تجنّبه بالتخطيط الاستباقي."}},

// ---------- notfall (Runde 5) ----------
{ c:"notfall", q:{de:"Nach einem kleinen Unfall zittert eine unverletzte beteiligte Person stark und wirkt verwirrt.", ar:"بعد حادث بسيط، يرتجف شخص غير مصاب بشدة ويبدو مرتبكاً."}, a:[
  {de:"Das können Anzeichen eines Schocks sein.", ar:"قد تكون هذه علامات صدمة نفسية."},{de:"Die Person beruhigen, warm halten und nicht allein lassen.", ar:"طمئن الشخص وأبقه دافئاً ولا تتركه بمفرده."},{de:"Ohne sichtbare Verletzung besteht garantiert kein Grund zur Beachtung.", ar:"بلا إصابة ظاهرة لا يوجد أي سبب للاهتمام مضمون."}], correct:[0,1],
  e:{de:"Ein Schockzustand kann auch ohne äussere Verletzung ernst sein.", ar:"قد تكون حالة الصدمة خطيرة حتى بلا إصابة ظاهرة."}},

// ---------- ausweis (Runde 5) ----------
{ c:"ausweis", q:{de:"Du hast innerhalb weniger Monate zwei Ordnungsbussen wegen Falschparkierens erhalten.", ar:"تلقيت غرامتين بسبب ركن خاطئ خلال أشهر قليلة."}, a:[
  {de:"Ordnungsbussen wegen Parkierens gelten meist nicht als schwere Widerhandlung.", ar:"غرامات الركن لا تُعتبر عادة مخالفة خطيرة."},{de:"Ein Muster von Regelverstössen kann trotzdem ungünstig auffallen.", ar:"قد يلفت نمط تكرار المخالفات النظر بشكل غير مناسب رغم ذلك."},{de:"Ordnungsbussen jeder Art führen immer automatisch zum Entzug des Führerausweises.", ar:"تؤدي غرامات المخالفات من أي نوع دائماً وتلقائياً إلى سحب الرخصة."}], correct:[0,1],
  e:{de:"Schwere Widerhandlungen betreffen vor allem Verkehrssicherheit, nicht jede Ordnungsbusse.", ar:"تخص المخالفات الخطيرة سلامة المرور بشكل أساسي، لا كل غرامة مخالفة."}},
