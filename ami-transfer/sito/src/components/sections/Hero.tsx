    ...
    <div className="relative h-[100svh] min-h-[620px] overflow-hidden bg-petrol">
      ...
      <div className="pointer-events-none absolute right-0 bottom-0 left-0 pb-[7vh]">
        <div className="mx-auto w-[min(1180px,92vw)]">
          <h1 className="max-w-[16ch] text-[clamp(40px,7.2vw,92px)] text-white" style={{ textShadow: "0 2px 40px rgba(11,34,48,.65)" }}>
            {h.title}
          </h1>
          <p className="mt-5 max-w-[46ch] text-[clamp(16px,1.6vw,19px)] text-[#b8c6cf]" style={{ textShadow: "0 2px 24px rgba(11,34,48,.8)" }}>
            {h.sub}
          </p>
