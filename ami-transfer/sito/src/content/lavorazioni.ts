...
// Elenco ricavato dal ciclo tipo già approvato nel prototipo. L'elenco completo
// delle lavorazioni realmente eseguite va confermato con l'azienda.
export const LAVORAZIONI: Lavorazione[] = [
  {
    ...
    lede:
      "Fori radiali e passanti eseguiti su una o più stazioni della linea, con unità operative dedicate posizionate sul passo richiesto dal disegno.",
    cosa: [
  ...
  },
  {
    ...
    lede:
      "Asportazione di materiale per deformazione dove la geometria del pezzo lo consente: più veloce della foratura e senza truciolo da gestire.",
    cosa: [
  ...
  },
  {
    ...
    lede:
      "Gruppi maschiatori integrati nella linea e sincronizzati con il ciclo di indexaggio, per filettare fori e estremità senza uscire dal transfer.",
    cosa: [
  ...
  },
  {
    ...
    lede:
      "Ripresa del diametro e della circolarità del tubo grezzo, per dare alle stazioni successive un riferimento stabile.",
    cosa: [
...
export function getLavorazione(slug: string) {
  return LAVORAZIONI.find((l) => l.slug === slug);
}
